...
public actor SSHConfigurator {
    ...
    public func saveSSHKeys(for _: String, publicKey: String, privateKey: String, machineDirectory: URL) throws {
    ...
    public func getSSHKeyPath(for _: String, machineDirectory: URL) -> URL {
