...
public actor ContainerizationRuntime: ContainerRuntimeProtocol {
    ...
    private func downloadOCILayerData(
    ...
    // MARK: - Kubernetes Domain Routing

    private func registerKubernetesDomainsIfNeeded(
    ...
    private func unregisterKubernetesDomainsIfNeeded(
        containerID: UUID,
        routingTable: DomainRoutingTable
    ) async {
