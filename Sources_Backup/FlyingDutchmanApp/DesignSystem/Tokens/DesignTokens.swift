...
public enum DesignTokens {
    ...
    public static func containerStatusSymbol(for status: ContainerSummary.Status) -> String {
        ...
        case .created, .starting, .stopping: "exclamationmark.triangle.fill"
        case .removing, .removed: "xmark.octagon.fill"
        }
    }
    ...
    public static func containerStatusColor(for status: ContainerSummary.Status) -> Color {
        ...
        case .stopped: DesignSystem.Colors.textTertiary
        case .created, .starting, .stopping: DesignSystem.Colors.warning
        case .removing, .removed: DesignSystem.Colors.error
        }
    }
}
