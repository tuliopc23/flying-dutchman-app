...
struct ContainerRow: View {
    ...
    private func containerStatusSymbol(for status: ContainerSummary.Status) -> String {
        ...
        case .stopped, .created, .removed: "stop.circle.fill"
        case .starting, .stopping, .removing: "arrow.triangle.2.circlepath.circle.fill"
        }
    }
    ...
    private func containerStatusColor(for status: ContainerSummary.Status) -> Color {
        ...
        case .stopped, .created, .removed: DesignSystem.Colors.textTertiary
        case .starting, .stopping, .removing: DesignSystem.Colors.warning
        }
    }
}
