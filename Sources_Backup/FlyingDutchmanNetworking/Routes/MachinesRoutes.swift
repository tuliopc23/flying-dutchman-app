...
struct MachinesRoutes {
    ...
    func register(on router: Router<BasicRequestContext>) {
        ...
        // Start a machine
        router.post("/machines/:nameOrID/start") { request, context in
        ...
        // Stop a machine
        router.post("/machines/:nameOrID/stop") { request, context in
            let nameOrID = try context.parameters.require("nameOrID")
        ...
        // Restart a machine
        router.post("/machines/:nameOrID/restart") { request, context in
            let nameOrID = try context.parameters.require("nameOrID")
        ...
        // Delete a machine
        router.delete("/machines/:nameOrID") { request, context in
            let nameOrID = try context.parameters.require("nameOrID")
