...
### Requirement: Container resource configuration
The system SHALL allow configuring CPU and memory limits for containers using LinuxContainer.Configuration.
