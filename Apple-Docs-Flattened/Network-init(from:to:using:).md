Source: https://developer.apple.com/documentation/network/nwconnection/init(from:to:using:)

[ Skip Navigation ](https://developer.apple.com/documentation/network/nwconnection/init\(from:to:using:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/network/nwconnection/init\(from:to:using:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/network/nwconnection/init\(from:to:using:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/network/nwconnection/init\(from:to:using:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/network/nwconnection/init\(from:to:using:\))
...
Navigator is ready 
  ...
  * [ init(from:to:using:) ](https://developer.apple.com/documentation/network/nwconnection/init\(from:to:using:\))
  *     * [ NWConnection ](https://developer.apple.com/documentation/network/nwconnection)
    * init(from:to:using:) 
...
```
convenience init?(
    from: [NWConnectionGroup](https://developer.apple.com/documentation/network/nwconnectiongroup),
    to: [NWEndpoint](https://developer.apple.com/documentation/network/nwendpoint)? = nil,
    using: [NWProtocolOptions](https://developer.apple.com/documentation/network/nwprotocoloptions)? = nil
)
```

Current page is init(from:to:using:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fnetwork%2Fnwconnection%2Finit\(from%3Ato%3Ausing%3A\)).
