Source: https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication

[ Skip Navigation ](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication)
...
[ Download ](https://docs-assets.developer.apple.com/published/dbe02a347c0c/LoggingSymptomsAssociatedWithAMedication.zip)
iOS 26.0+iPadOS 26.0+Xcode 26.0+
## [Overview](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication#Overview)
Note
...
### [Configure the sample code project](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication#Configure-the-sample-code-project)
...
## [See Also](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication#see-also)
### [Health data](https://developer.apple.com/documentation/healthkit/logging-symptoms-associated-with-a-medication#Health-data)
...
Current page is Logging symptoms associated with a medication 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fhealthkit%2Flogging-symptoms-associated-with-a-medication).
