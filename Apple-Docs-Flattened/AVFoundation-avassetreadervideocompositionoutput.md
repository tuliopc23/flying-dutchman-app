Source: https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput

[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 8 symbols inside 866794560 
Creating a video composition output
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 8 symbols inside 866794560 [init(videoTracks: [AVAssetTrack], videoSettings: [String : Any]?)](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/init\(videotracks:videosettings:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 8 symbols inside 866794560 
Configuring video settings
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
4 of 8 symbols inside 866794560 [var videoComposition: AVVideoComposition?](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/videocomposition)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
5 of 8 symbols inside 866794560 [var customVideoCompositor: (any AVVideoCompositing)?](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/customvideocompositor)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
6 of 8 symbols inside 866794560 
Inspecting an output
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
7 of 8 symbols inside 866794560 [var videoTracks: [AVAssetTrack]](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/videotracks)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
8 of 8 symbols inside 866794560 [var videoSettings: [String : Any]?](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/videosettings)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
## [Topics](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#topics)
### [Creating a video composition output](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#Creating-a-video-composition-output)
[`init(videoTracks: [AVAssetTrack], videoSettings: [String : Any]?)`](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/init\(videotracks:videosettings:\))
Creates an object that reads composited video frames from the specified video tracks.
### [Configuring video settings](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#Configuring-video-settings)
[`var videoComposition: AVVideoComposition?`](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/videocomposition)
The video composition to use for the output.
[`var customVideoCompositor: (any AVVideoCompositing)?`](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/customvideocompositor)
A custom video compositor for the output.
### [Inspecting an output](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#Inspecting-an-output)
[`var videoTracks: [AVAssetTrack]`](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/videotracks)
The tracks from which the output reads the composited video.
[`var videoSettings: [String : Any]?`](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput/videosettings)
The video settings that the output uses.
## [Relationships](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#relationships)
### [Inherits From](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#inherits-from)
  * [`AVAssetReaderOutput`](https://developer.apple.com/documentation/avfoundation/avassetreaderoutput)


### [Conforms To](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#see-also)
### [Media reading](https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput#Media-reading)
...
Current page is AVAssetReaderVideoCompositionOutput 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Favassetreadervideocompositionoutput).
