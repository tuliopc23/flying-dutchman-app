Source: https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor

[ Skip Navigation ](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor)
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 4 symbols inside -300339354 
Creating the extractor
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 4 symbols inside -300339354 [init()](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor/init\(\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 4 symbols inside -300339354 
Extracting the body pose
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
4 of 4 symbols inside -300339354 [func applied(to: CIImage, eventHandler: EventHandler?) async throws -> [Pose]](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor/applied\(to:eventhandler:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
35 of 217 symbols inside <root> containing 12 symbols[DateFeatures](https://developer.apple.com/documentation/createmlcomponents/datefeatures)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
36 of 217 symbols inside <root> containing 7 symbols[DateFeatureExtractor](https://developer.apple.com/documentation/createmlcomponents/datefeatureextractor)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
37 of 217 symbols inside <root> containing 19 symbols[LinearTimeSeriesForecaster](https://developer.apple.com/documentation/createmlcomponents/lineartimeseriesforecaster)
221 items were found. Tab back to navigate through them. 
/ 
Navigator is ready 
  * [ Create ML Components ](https://developer.apple.com/documentation/createmlcomponents)
...
## [Topics](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#topics)
### [Creating the extractor](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#Creating-the-extractor)
[`init()`](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor/init\(\))
Creates a human body pose extractor transformer
### [Extracting the body pose](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#Extracting-the-body-pose)
[`func applied(to: CIImage, eventHandler: EventHandler?) async throws -> [Pose]`](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor/applied\(to:eventhandler:\))
Extracts human body poses from a pixel buffer.
## [Relationships](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#relationships)
### [Conforms To](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#see-also)
### [Pose components](https://developer.apple.com/documentation/createmlcomponents/humanbodyposeextractor#Pose-components)
...
Current page is HumanBodyPoseExtractor 
