Source: https://developer.apple.com/documentation/network/nwconnection/init(host:port:using:)

[ Skip Navigation ](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\))
...
Navigator is ready 
  ...
  * [ init(host:port:using:) ](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\))
  *     * [ NWConnection ](https://developer.apple.com/documentation/network/nwconnection)
...
```
convenience init(
    host: [NWEndpoint](https://developer.apple.com/documentation/network/nwendpoint).[Host](https://developer.apple.com/documentation/network/nwendpoint/host),
    port: [NWEndpoint](https://developer.apple.com/documentation/network/nwendpoint).[Port](https://developer.apple.com/documentation/network/nwendpoint/port),
    using: [NWParameters](https://developer.apple.com/documentation/network/nwparameters)
)
```

## [See Also](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\)#see-also)
### [Creating Connections](https://developer.apple.com/documentation/network/nwconnection/init\(host:port:using:\)#Creating-Connections)
...
Current page is init(host:port:using:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fnetwork%2Fnwconnection%2Finit\(host%3Aport%3Ausing%3A\)).
