...
[ Skip Navigation ](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\))
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 81 symbols inside 759532354 
Adding state-based animation to an action
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
2 of 81 symbols inside 759532354 [func withAnimation<Result>(Animation?, () throws -> Result) rethrows -> Result](https://developer.apple.com/documentation/swiftui/withanimation\(_:_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
func withAnimation<Result>(
    _ animation: [Animation](https://developer.apple.com/documentation/swiftui/animation)? = .default,
    _ body: () throws -> Result
) rethrows -> Result
```

## [ Mentioned in ](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\)#mentions)
[](https://developer.apple.com/documentation/swiftui/applying-liquid-glass-to-custom-views)
[](https://developer.apple.com/documentation/swiftui/managing-user-interface-state)
## [Discussion](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\)#discussion)
This function sets the given [`Animation`](https://developer.apple.com/documentation/swiftui/animation) as the [`animation`](https://developer.apple.com/documentation/swiftui/transaction/animation) property of the thread’s current [`Transaction`](https://developer.apple.com/documentation/swiftui/transaction).
## [See Also](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\)#see-also)
### [Adding state-based animation to an action](https://developer.apple.com/documentation/SwiftUI/withAnimation\(_:_:\)#Adding-state-based-animation-to-an-action)
[`func withAnimation<Result>(Animation?, completionCriteria: AnimationCompletionCriteria, () throws -> Result, completion: () -> Void) rethrows -> Result`](https://developer.apple.com/documentation/swiftui/withanimation\(_:completioncriteria:_:completion:\))
...
[`struct AnimationCompletionCriteria`](https://developer.apple.com/documentation/swiftui/animationcompletioncriteria)
The criteria that determines when an animation is considered finished.
[`struct Animation`](https://developer.apple.com/documentation/swiftui/animation)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSwiftUI%2FwithAnimation\(_%3A_%3A\)).
