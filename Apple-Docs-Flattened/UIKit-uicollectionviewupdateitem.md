Source: https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem

[ Skip Navigation ](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
23 of 42 symbols inside 840669288 containing 9 symbols[NSCollectionLayoutBoundarySupplementaryItem](https://developer.apple.com/documentation/uikit/nscollectionlayoutboundarysupplementaryitem)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
24 of 42 symbols inside 840669288 containing 6 symbols[NSCollectionLayoutDecorationItem](https://developer.apple.com/documentation/uikit/nscollectionlayoutdecorationitem)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
24 of 42 symbols inside 840669288 containing 6 symbols[NSCollectionLayoutDecorationItem](https://developer.apple.com/documentation/uikit/nscollectionlayoutdecorationitem)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
25 of 42 symbols inside 840669288 
Advanced layouts
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
26 of 42 symbols inside 840669288 containing 7 symbols[NSCollectionLayoutGroupCustomItem](https://developer.apple.com/documentation/uikit/nscollectionlayoutgroupcustomitem)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
T
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 5 symbols inside 796766786 
Accessing the item changes
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 5 symbols inside 796766786 [var indexPathBeforeUpdate: IndexPath?](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/indexpathbeforeupdate)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
3 of 5 symbols inside 796766786 [var indexPathAfterUpdate: IndexPath?](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/indexpathafterupdate)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
4 of 5 symbols inside 796766786 [var updateAction: UICollectionViewUpdateItem.Action](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/updateaction)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
E
5 of 5 symbols inside 796766786 containing 8 symbols[UICollectionViewUpdateItem.Action](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/action)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
Navigator is ready 
  * [ UIKit ](https://developer.apple.com/documentation/uikit)
  * [ UICollectionViewUpdateItem ](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem)
...
## [Overview](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#overview)
You don’t create instances of this class directly. When updating its content, the collection view object creates them and passes them to the layout object’s [`prepare(forCollectionViewUpdates:)`](https://developer.apple.com/documentation/uikit/uicollectionviewlayout/prepare\(forcollectionviewupdates:\)) method, which can use them to prepare the layout object for the upcoming changes.
## [Topics](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#topics)
### [Accessing the item changes](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#Accessing-the-item-changes)
[`var indexPathBeforeUpdate: IndexPath?`](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/indexpathbeforeupdate)
The index path of the item before the update.
[`var indexPathAfterUpdate: IndexPath?`](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/indexpathafterupdate)
The index path of the item after the update.
[`var updateAction: UICollectionViewUpdateItem.Action`](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/updateaction)
The action being performed on the item.
[`enum Action`](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem/action)
Constants indicating the type of action being performed on an item.
## [Relationships](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#relationships)
### [Inherits From](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#see-also)
### [Layout updates](https://developer.apple.com/documentation/uikit/uicollectionviewupdateitem#Layout-updates)
[`protocol NSCollectionLayoutVisibleItem`](https://developer.apple.com/documentation/uikit/nscollectionlayoutvisibleitem)
An item that’s currently visible within the bounds of a section.
[`typealias NSCollectionLayoutSectionVisibleItemsInvalidationHandler`](https://developer.apple.com/documentation/uikit/nscollectionlayoutsectionvisibleitemsinvalidationhandler)
...
[`class UICollectionViewFocusUpdateContext`](https://developer.apple.com/documentation/uikit/uicollectionviewfocusupdatecontext)
A context object that stores information specific to a focus update in a collection view.
[`class UICollectionViewLayoutInvalidationContext`](https://developer.apple.com/documentation/uikit/uicollectionviewlayoutinvalidationcontext)
A context object that declares which parts of your layout need to be updated when the layout is invalidated.
Current page is UICollectionViewUpdateItem 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fuikit%2Fuicollectionviewupdateitem).
