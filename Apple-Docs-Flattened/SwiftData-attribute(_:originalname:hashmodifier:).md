Source: https://developer.apple.com/documentation/SwiftData/Attribute(_:originalName:hashModifier:)

[ Skip Navigation ](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\))
  * SwiftLanguage: Swift
...
Navigator is ready 
  * [ SwiftData ](https://developer.apple.com/documentation/swiftdata)
  * [ Attribute(_:originalName:hashModifier:) ](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\))
...
@attached(peer)
macro Attribute(
    _ options: [Schema](https://developer.apple.com/documentation/swiftdata/schema).[Attribute](https://developer.apple.com/documentation/swiftdata/schema/attribute).[Option](https://developer.apple.com/documentation/swiftdata/schema/attribute/option)...,
    originalName: [String](https://developer.apple.com/documentation/Swift/String)? = nil,
    hashModifier: [String](https://developer.apple.com/documentation/Swift/String)? = nil
)
```

## [ Parameters ](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#parameters) 

`options`
    
A list of options to apply to the attached property to customize its behavior. For possible values, see [`Schema.Attribute.Option`](https://developer.apple.com/documentation/swiftdata/schema/attribute/option). 
...
## [ Mentioned in ](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#mentions)
[](https://developer.apple.com/documentation/swiftdata/fetching-and-filtering-time-based-model-changes)
[](https://developer.apple.com/documentation/swiftdata/preserving-your-apps-model-data-across-launches)
## [Overview](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#overview)
...
## [See Also](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#see-also)
### [Model definition](https://developer.apple.com/documentation/SwiftData/Attribute\(_:originalName:hashModifier:\)#Model-definition)
...
Current page is Attribute(_:originalName:hashModifier:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSwiftData%2FAttribute\(_%3AoriginalName%3AhashModifier%3A\)).
