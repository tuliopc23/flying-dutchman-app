Source: https://developer.apple.com/documentation/appintents/intentvaluequery/values(for:)

[ Skip Navigation ](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\))
...
Navigator is ready 
  ...
  * [ values(for:) ](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\))
  *     * [ IntentValueQuery ](https://developer.apple.com/documentation/appintents/intentvaluequery)
    * values(for:) 
...
```
func values(for input: Self.[Input](https://developer.apple.com/documentation/appintents/intentvaluequery/input)) async throws -> Self.[Result](https://developer.apple.com/documentation/appintents/intentvaluequery/result)
```

**Required**
Current page is values(for:) 
