Source: https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata

[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata)


[](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
18 of 46 symbols inside 1611915091 [var sampleReferenceBaseURL: URL?](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/samplereferencebaseurl)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
19 of 46 symbols inside 1611915091 [var mediaDataLocation: AVAssetWriterInput.MediaDataLocation](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/mediadatalocation-swift.property)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
19 of 46 symbols inside 1611915091 [var mediaDataLocation: AVAssetWriterInput.MediaDataLocation](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/mediadatalocation-swift.property)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
20 of 46 symbols inside 1611915091 containing 6 symbols[AVAssetWriterInput.MediaDataLocation](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/mediadatalocation-swift.struct)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
iOS 4.1+iPadOS 4.1+Mac Catalyst 13.1+macOS 10.7–11.0DeprecatedtvOS 9.0–26.2DeprecatedvisionOS 1.0+
```
var isReadyForMoreMediaData: [Bool](https://developer.apple.com/documentation/Swift/Bool) { get }
```

## [Discussion](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata#Discussion)
...
Apps that write media data from a non-real-time source, such as an instance of [`AVAssetReader`](https://developer.apple.com/documentation/avfoundation/avassetreader), wait to generate or retrieve more media data while this property value is [`false`](https://developer.apple.com/documentation/Swift/false). To control of the supply of non-real-time media data, use the [`requestMediaDataWhenReady(on:using:)`](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/requestmediadatawhenready\(on:using:\)) method to specify a callback for the input to invoke when it’s ready to append more data.
Apps that write media data from a real-time source, such as an instance of [`AVCaptureOutput`](https://developer.apple.com/documentation/avfoundation/avcaptureoutput), set the input’s [`expectsMediaDataInRealTime`](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/expectsmediadatainrealtime) property value to [`true`](https://developer.apple.com/documentation/Swift/true) so that the input accurately determines its readiness for more data. When [`expectsMediaDataInRealTime`](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/expectsmediadatainrealtime) is [`true`](https://developer.apple.com/documentation/Swift/true), this property value becomes [`false`](https://developer.apple.com/documentation/Swift/false) only when the input can’t process media samples at the current data rate. If this property value becomes [`false`](https://developer.apple.com/documentation/Swift/false) for a real-time source, your app may need to reduce the rate at which it appends samples, or drop them altogether.
If the [`canPerformMultiplePasses`](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/canperformmultiplepasses) value of any of an asset writer’s inputs is [`true`](https://developer.apple.com/documentation/Swift/true), the value of this property may start as [`false`](https://developer.apple.com/documentation/Swift/false), and remain that way for extended periods.
...
## [See Also](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata#see-also)
### [Appending media samples](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/isreadyformoremediadata#Appending-media-samples)
...
[`func markAsFinished()`](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/markasfinished\(\))
...
Current page is isReadyForMoreMediaData 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Favassetwriterinput%2Fisreadyformoremediadata).
