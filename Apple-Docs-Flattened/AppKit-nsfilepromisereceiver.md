Source: https://developer.apple.com/documentation/appkit/nsfilepromisereceiver

[ Skip Navigation ](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver)


[](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 7 symbols inside -128305647 
Instance Properties
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 7 symbols inside -128305647 [var fileNames: [String]](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/filenames)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
3 of 7 symbols inside -128305647 [var fileTypes: [String]](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/filetypes)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
4 of 7 symbols inside -128305647 
Instance Methods
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
5 of 7 symbols inside -128305647 [func receivePromisedFiles(atDestination: URL, options: [AnyHashable : Any], operationQueue: OperationQueue, reader: (URL, (any Error)?) -> Void)](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/receivepromisedfiles\(atdestination:options:operationqueue:reader:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
6 of 7 symbols inside -128305647 
Type Properties
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
7 of 7 symbols inside -128305647 [class var readableDraggedTypes: [String]](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/readabledraggedtypes)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
## [Overview](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#overview)
Because [`NSFilePromiseReceiver`](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver) implements the [`NSPasteboardReading`](https://developer.apple.com/documentation/appkit/nspasteboardreading) protocol, you receive all file promises on the drag pasteboard as follows:
  * [ Swift ](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver)
  * [ Objective-C ](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver)
...
## [Topics](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#topics)
### [Instance Properties](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#Instance-Properties)
[`var fileNames: [String]`](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/filenames)
An array containing names of the promised files being written to the destination location.
[`var fileTypes: [String]`](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/filetypes)
An array containing types of the promised files being written to the destination location.
### [Instance Methods](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#Instance-Methods)
[`func receivePromisedFiles(atDestination: URL, options: [AnyHashable : Any], operationQueue: OperationQueue, reader: (URL, (any Error)?) -> Void)`](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/receivepromisedfiles\(atdestination:options:operationqueue:reader:\))
Fulfills the promises at the specified destination.
### [Type Properties](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#Type-Properties)
[`class var readableDraggedTypes: [String]`](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver/readabledraggedtypes)
An array containing dragged file types that are readable.
## [Relationships](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#relationships)
### [Inherits From](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#see-also)
### [File Promises](https://developer.apple.com/documentation/appkit/nsfilepromisereceiver#File-Promises)
...
Current page is NSFilePromiseReceiver 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fappkit%2Fnsfilepromisereceiver).
