Source: https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats

[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats)
...
## [Overview](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats#overview)
...
Tip
If your app can save a movie directly from video capture, it’s more efficient to change the default format during capture by following the steps in [Recording movies in alternative formats](https://developer.apple.com/documentation/avfoundation/recording-movies-in-alternative-formats).
### [Export a new video to the desired format](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats#Export-a-new-video-to-the-desired-format)
To export a video to a different format, begin with an [`AVAsset`](https://developer.apple.com/documentation/avfoundation/avasset) movie file and perform these steps:
  1. Choose an export preset from the list of [Export presets](https://developer.apple.com/documentation/avfoundation/export-presets).
  2. Choose an export file type from the list of [`AVFileType`](https://developer.apple.com/documentation/avfoundation/avfiletype) presets.
  3. Verify that [`AVAssetExportSession`](https://developer.apple.com/documentation/avfoundation/avassetexportsession) can convert the movie from the input format to the output format you want.
  4. Create and configure an [`AVAssetExportSession`](https://developer.apple.com/documentation/avfoundation/avassetexportsession) instance, and then use it to perform the export.
...
## [See Also](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats#see-also)
### [Media export](https://developer.apple.com/documentation/avfoundation/exporting-video-to-alternative-formats#Media-export)
...
Current page is Exporting video to alternative formats 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Fexporting-video-to-alternative-formats).
