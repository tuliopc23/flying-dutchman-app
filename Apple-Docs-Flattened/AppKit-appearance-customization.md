Source: https://developer.apple.com/documentation/appkit/appearance-customization

[ Skip Navigation ](https://developer.apple.com/documentation/appkit/appearance-customization#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appkit/appearance-customization#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appkit/appearance-customization)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appkit/appearance-customization)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/appkit/appearance-customization)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 5 symbols inside -459271801 
Dark Mode
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
2 of 5 symbols inside -459271801 [Supporting Dark Mode in your interface](https://developer.apple.com/documentation/uikit/supporting-dark-mode-in-your-interface)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 5 symbols inside -459271801 
Appearance System
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
4 of 5 symbols inside -459271801 containing 15 symbols[NSAppearance](https://developer.apple.com/documentation/appkit/nsappearance)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
5 of 5 symbols inside -459271801 containing 4 symbols[NSAppearanceCustomization](https://developer.apple.com/documentation/appkit/nsappearancecustomization)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
...
## [Topics](https://developer.apple.com/documentation/appkit/appearance-customization#topics)
### [Dark Mode](https://developer.apple.com/documentation/appkit/appearance-customization#Dark-Mode)
...
### [Appearance System](https://developer.apple.com/documentation/appkit/appearance-customization#Appearance-System)
Apply standard themes to the views in your interface.
[`class NSAppearance`](https://developer.apple.com/documentation/appkit/nsappearance)
An object that manages standard appearance attributes for UI elements in an app.
[`protocol NSAppearanceCustomization`](https://developer.apple.com/documentation/appkit/nsappearancecustomization)
A set of methods for getting and setting the appearance attributes of a view.
## [See Also](https://developer.apple.com/documentation/appkit/appearance-customization#see-also)
### [User Interface](https://developer.apple.com/documentation/appkit/appearance-customization#User-Interface)
...
Current page is Appearance Customization 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fappkit%2Fappearance-customization).
