Source: https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext

[ Skip Navigation ](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 3 symbols inside 1768122106 
Locating focusable items in a table view
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 3 symbols inside 1768122106 [var previouslyFocusedIndexPath: IndexPath?](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext/previouslyfocusedindexpath)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
3 of 3 symbols inside 1768122106 [var nextFocusedIndexPath: IndexPath?](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext/nextfocusedindexpath)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
23 of 42 symbols inside 2110409461 containing 25 symbols[UITableViewHeaderFooterView](https://developer.apple.com/documentation/uikit/uitableviewheaderfooterview)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
24 of 42 symbols inside 2110409461 
Row actions
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
25 of 42 symbols inside 2110409461 containing 5 symbols[UISwipeActionsConfiguration](https://developer.apple.com/documentation/uikit/uiswipeactionsconfiguration)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
26 of 42 symbols inside 2110409461 containing 11 symbols[UIContextualAction](https://developer.apple.com/documentation/uikit/uicontextualaction)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
27 of 42 symbols inside 2110409461 containing 8 symbols[UITableViewRowAction](https://developer.apple.com/documentation/uikit/uitableviewrowaction)Deprecated
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
28 of 42 symbols inside 2110409461 
Selection management
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
29 of 42 symbols inside 2110409461 [Handling row selection in a table view](https://developer.apple.com/documentation/uikit/handling-row-selection-in-a-table-view)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
30 of 42 symbols inside 2110409461 [Selecting multiple items with a two-finger pan gesture](https://developer.apple.com/documentation/uikit/selecting-multiple-items-with-a-two-finger-pan-gesture)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
31 of 42 symbols inside 2110409461 
Drag and drop
161 items were found. Tab back to navigate through them. 
/ 
Navigator is ready 
  * [ UIKit ](https://developer.apple.com/documentation/uikit)
  * [ UITableViewFocusUpdateContext ](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext)
...
## [Overview](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#overview)
...
## [Topics](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#topics)
### [Locating focusable items in a table view](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#Locating-focusable-items-in-a-table-view)
[`var previouslyFocusedIndexPath: IndexPath?`](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext/previouslyfocusedindexpath)
Returns the index path of the cell containing the context’s previously focused view.
[`var nextFocusedIndexPath: IndexPath?`](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext/nextfocusedindexpath)
Returns the index path of the cell containing the context’s next focused view.
## [Relationships](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#relationships)
### [Inherits From](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#inherits-from)
  * [`UIFocusUpdateContext`](https://developer.apple.com/documentation/uikit/uifocusupdatecontext)


### [Conforms To](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#see-also)
### [Table management](https://developer.apple.com/documentation/uikit/uitableviewfocusupdatecontext#Table-management)
[Estimating the height of a table’s scrolling area](https://developer.apple.com/documentation/uikit/estimating-the-height-of-a-table-s-scrolling-area)
...
[`class UITableViewController`](https://developer.apple.com/documentation/uikit/uitableviewcontroller)
A view controller that specializes in managing a table view.
[`protocol UITableViewDelegate`](https://developer.apple.com/documentation/uikit/uitableviewdelegate)
Methods for managing selections, configuring section headers and footers, deleting and reordering cells, and performing other actions in a table view.
Current page is UITableViewFocusUpdateContext 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fuikit%2Fuitableviewfocusupdatecontext).
