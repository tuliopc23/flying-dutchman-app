...
[ Skip Navigation ](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder)
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder)
...
Navigator is ready 
  ...
  * [ roundedBorder ](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder)
  *     * [ TextFieldStyle ](https://developer.apple.com/documentation/swiftui/textfieldstyle)
    * roundedBorder 
...
```
static var roundedBorder: [RoundedBorderTextFieldStyle](https://developer.apple.com/documentation/swiftui/roundedbordertextfieldstyle) { get }
```

Available when `Self` is `RoundedBorderTextFieldStyle`.
## [See Also](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder#see-also)
### [Getting built-in text field styles](https://developer.apple.com/documentation/swiftui/textfieldstyle/roundedborder#Getting-built-in-text-field-styles)
[`static var automatic: DefaultTextFieldStyle`](https://developer.apple.com/documentation/swiftui/textfieldstyle/automatic)
The default text field style, based on the text field’s context.
[`static var plain: PlainTextFieldStyle`](https://developer.apple.com/documentation/swiftui/textfieldstyle/plain)
A text field style with no decoration.
[`static var squareBorder: SquareBorderTextFieldStyle`](https://developer.apple.com/documentation/swiftui/textfieldstyle/squareborder)
A text field style with a system-defined square border.
Current page is roundedBorder 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fswiftui%2Ftextfieldstyle%2Froundedborder).
