Source: https://developer.apple.com/documentation/createml/mldatatable/init(dictionary:)

[ Skip Navigation ](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\))
  * SwiftLanguage: Swift
...
Navigator is ready 
  ...
  * [ init(dictionary:) ](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\))
  *     * [ MLDataTable ](https://developer.apple.com/documentation/createml/mldatatable)
    * init(dictionary:) 
...
```
init(dictionary: [[String](https://developer.apple.com/documentation/Swift/String) : any [MLDataValueConvertible](https://developer.apple.com/documentation/createml/mldatavalueconvertible)]) throws
```

## [ Parameters ](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)#parameters) 

`dictionary`
    
The dictionary of each column name and its associated data values.
## [Discussion](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)#discussion)
...
Then, use [`init(dictionary:)`](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)) to create a data table from the dictionary.
```
...
## [See Also](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)#see-also)
### [Creating a data table](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\)#Creating-a-data-table)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fcreateml%2Fmldatatable%2Finit\(dictionary%3A\)).
