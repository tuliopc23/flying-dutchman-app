...
[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 12 symbols inside -768898744 
Creating an assistant
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 12 symbols inside -768898744 [convenience init?(preset: AVOutputSettingsPreset)](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/init\(preset:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
3 of 12 symbols inside -768898744 containing 18 symbols[AVOutputSettingsPreset](https://developer.apple.com/documentation/avfoundation/avoutputsettingspreset)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
4 of 12 symbols inside -768898744 [class func availableOutputSettingsPresets() -> [AVOutputSettingsPreset]](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/availableoutputsettingspresets\(\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
5 of 12 symbols inside -768898744 
Configuring output settings
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
6 of 12 symbols inside -768898744 [var outputFileType: AVFileType](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/outputfiletype)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
7 of 12 symbols inside -768898744 [var audioSettings: [String : Any]?](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/audiosettings)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
8 of 12 symbols inside -768898744 [var sourceAudioFormat: CMAudioFormatDescription?](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourceaudioformat)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
9 of 12 symbols inside -768898744 [var videoSettings: [String : Any]?](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/videosettings)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
10 of 12 symbols inside -768898744 [var sourceVideoFormat: CMVideoFormatDescription?](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourcevideoformat)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
11 of 12 symbols inside -768898744 [var sourceVideoMinFrameDuration: CMTime](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourcevideominframeduration)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
12 of 12 symbols inside -768898744 [var sourceVideoAverageFrameDuration: CMTime](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourcevideoaverageframeduration)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
## [Topics](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#topics)
### [Creating an assistant](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#Creating-an-assistant)
[`convenience init?(preset: AVOutputSettingsPreset)`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/init\(preset:\))
Creates an output setting assistant with a preset configuration.
[`struct AVOutputSettingsPreset`](https://developer.apple.com/documentation/avfoundation/avoutputsettingspreset)
A structure that defines preset configurations for an output settings assistant.
[`class func availableOutputSettingsPresets() -> [AVOutputSettingsPreset]`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/availableoutputsettingspresets\(\))
Returns an array of preset values to use to initialize an output settings assistant.
### [Configuring output settings](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#Configuring-output-settings)
[`var outputFileType: AVFileType`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/outputfiletype)
A uniform type identifier (UTI) that indicates the type of file to write.
[`var audioSettings: [String : Any]?`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/audiosettings)
An audio settings dictionary.
[`var sourceAudioFormat: CMAudioFormatDescription?`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourceaudioformat)
The format of the source audio data.
[`var videoSettings: [String : Any]?`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/videosettings)
A video settings dictionary.
[`var sourceVideoFormat: CMVideoFormatDescription?`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourcevideoformat)
The format of the source video data.
[`var sourceVideoMinFrameDuration: CMTime`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourcevideominframeduration)
A time value that describes the minimum frame duration of the video data.
[`var sourceVideoAverageFrameDuration: CMTime`](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant/sourcevideoaverageframeduration)
A time value that describes the average frame duration of the video data.
## [Relationships](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#relationships)
### [Inherits From](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#see-also)
### [Media writing](https://developer.apple.com/documentation/avfoundation/avoutputsettingsassistant#Media-writing)
...
Current page is AVOutputSettingsAssistant 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Favoutputsettingsassistant).
