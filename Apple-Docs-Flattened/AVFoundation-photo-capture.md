Source: https://developer.apple.com/documentation/avfoundation/photo-capture

[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/photo-capture#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/photo-capture#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/photo-capture)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/photo-capture)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/photo-capture)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
3 of 19 symbols inside -820640427 containing 9 symbols[Capturing still and Live Photos](https://developer.apple.com/documentation/avfoundation/capturing-still-and-live-photos)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
[API Reference Capture setup](https://developer.apple.com/documentation/avfoundation/capture-setup)
Configure built-in cameras and microphones, and external capture devices, for media capture.
[API Reference Audio and video capture](https://developer.apple.com/documentation/avfoundation/audio-and-video-capture)
Capture audio and video directly to media files, or capture streams of media for direct access to media sample buffers.
[API Reference Additional data capture](https://developer.apple.com/documentation/avfoundation/additional-data-capture)
Capture additional data including depth and metadata, and synchronize capture from multiple outputs.
Current page is Photo capture 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Fphoto-capture).
