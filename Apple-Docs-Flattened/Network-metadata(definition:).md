Source: https://developer.apple.com/documentation/network/nwconnection/metadata(definition:)

[ Skip Navigation ](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\))
...
Navigator is ready 
  ...
  * [ metadata(definition:) ](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\))
  *     * [ NWConnection ](https://developer.apple.com/documentation/network/nwconnection)
    * metadata(definition:) 
...
```
final func metadata(definition: [NWProtocolDefinition](https://developer.apple.com/documentation/network/nwprotocoldefinition)) -> [NWProtocolMetadata](https://developer.apple.com/documentation/network/nwprotocolmetadata)?
```

## [See Also](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\)#see-also)
### [Inspecting Connections](https://developer.apple.com/documentation/network/nwconnection/metadata\(definition:\)#Inspecting-Connections)
...
Current page is metadata(definition:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fnetwork%2Fnwconnection%2Fmetadata\(definition%3A\)).
