Source: https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous(completion:)

[ Skip Navigation ](https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous\(completion:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous\(completion:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous\(completion:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous\(completion:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous\(completion:\))
...
Navigator is ready 
  ...
  * [ receiveMessageDiscontiguous(completion:) ](https://developer.apple.com/documentation/network/nwconnection/receivemessagediscontiguous\(completion:\))
  *     * [ NWConnection ](https://developer.apple.com/documentation/network/nwconnection)
...
```
@preconcurrency
final func receiveMessageDiscontiguous(completion: @escaping ([DispatchData](https://developer.apple.com/documentation/Dispatch/DispatchData)?, [NWConnection](https://developer.apple.com/documentation/network/nwconnection).[ContentContext](https://developer.apple.com/documentation/network/nwconnection/contentcontext)?, [Bool](https://developer.apple.com/documentation/Swift/Bool), [NWError](https://developer.apple.com/documentation/network/nwerror)?) -> [Void](https://developer.apple.com/documentation/Swift/Void))
```

Current page is receiveMessageDiscontiguous(completion:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fnetwork%2Fnwconnection%2Freceivemessagediscontiguous\(completion%3A\)).
