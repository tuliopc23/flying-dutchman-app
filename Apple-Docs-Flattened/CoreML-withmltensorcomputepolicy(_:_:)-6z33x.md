Source: https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy(_:_:)-6z33x

[ Skip Navigation ](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x)
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x)
...
Navigator is ready 
  * [ Core ML ](https://developer.apple.com/documentation/coreml)
  * [ withMLTensorComputePolicy(_:_:) ](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x)
...
```
func withMLTensorComputePolicy<Result>(
    _ computePolicy: [MLComputePolicy](https://developer.apple.com/documentation/coreml/mlcomputepolicy),
    _ body: () throws -> Result
) rethrows -> Result
```

Show all declarations 
## [ Parameters ](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x#parameters) 
...
## [Return Value](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x#return-value)
The return value, if any, of the `body` closure.
## [See Also](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x#see-also)
### [Compute plan](https://developer.apple.com/documentation/coreml/withmltensorcomputepolicy\(_:_:\)-6z33x#Compute-plan)
...
Calls the given closure within a task-local context using the specified compute policy to influence what compute device tensor operations are executed on.
Current page is withMLTensorComputePolicy(_:_:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fcoreml%2Fwithmltensorcomputepolicy\(_%3A_%3A\)-6z33x).
