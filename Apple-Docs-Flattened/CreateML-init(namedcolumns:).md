Source: https://developer.apple.com/documentation/createml/mldatatable/init(namedcolumns:)

[ Skip Navigation ](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\))
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 56 symbols inside -1040997590 
Creating a data table
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
2 of 56 symbols inside -1040997590 [Creating a model from tabular data](https://developer.apple.com/documentation/createml/creating-a-model-from-tabular-data)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 56 symbols inside -1040997590 containing 3 symbols[init(contentsOf: URL, options: MLDataTable.ParsingOptions) throws](https://developer.apple.com/documentation/createml/mldatatable/init\(contentsof:options:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
4 of 56 symbols inside -1040997590 [init(dictionary: [String : any MLDataValueConvertible]) throws](https://developer.apple.com/documentation/createml/mldatatable/init\(dictionary:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
5 of 56 symbols inside -1040997590 [init(namedColumns: [String : MLUntypedColumn]) throws](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
6 of 56 symbols inside -1040997590 [init()](https://developer.apple.com/documentation/createml/mldatatable/init\(\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
7 of 56 symbols inside -1040997590 containing 19 symbols[MLDataTable.ParsingOptions](https://developer.apple.com/documentation/createml/mldatatable/parsingoptions)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
8 of 56 symbols inside -1040997590 
Getting the size of a data table
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
9 of 56 symbols inside -1040997590 [var size: (rows: Int, columns: Int)](https://developer.apple.com/documentation/createml/mldatatable/size)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
Navigator is ready 
  ...
  * [ init(namedColumns:) ](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\))
  *     * [ MLDataTable ](https://developer.apple.com/documentation/createml/mldatatable)
    * init(namedColumns:) 
...
```
init(namedColumns: [[String](https://developer.apple.com/documentation/Swift/String) : [MLUntypedColumn](https://developer.apple.com/documentation/createml/mluntypedcolumn)]) throws
```

## [ Parameters ](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)#parameters) 

`namedColumns`
    
The dictionary of each column name and its associated untyped column data.
## [Discussion](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)#discussion)
...
Then, use [`init(namedColumns:)`](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)) to create a data table from the columns paired with their names.
```
...
## [See Also](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)#see-also)
### [Creating a data table](https://developer.apple.com/documentation/createml/mldatatable/init\(namedcolumns:\)#Creating-a-data-table)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fcreateml%2Fmldatatable%2Finit\(namedcolumns%3A\)).
