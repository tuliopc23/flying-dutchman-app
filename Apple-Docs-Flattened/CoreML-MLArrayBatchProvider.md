...
[ Skip Navigation ](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 5 symbols inside 677346664 
Creating a batch provider
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 5 symbols inside 677346664 [init(array: [any MLFeatureProvider])](https://developer.apple.com/documentation/coreml/mlarraybatchprovider/init\(array:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 5 symbols inside 677346664 [init(dictionary: [String : [Any]]) throws](https://developer.apple.com/documentation/coreml/mlarraybatchprovider/init\(dictionary:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
4 of 5 symbols inside 677346664 
Accessing the feature providers
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
5 of 5 symbols inside 677346664 [var array: [any MLFeatureProvider]](https://developer.apple.com/documentation/coreml/mlarraybatchprovider/array)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
## [Overview](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#overview)
This batch provider supports an array of feature providers or a dictionary of arrays of feature values.
## [Topics](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#topics)
### [Creating a batch provider](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#Creating-a-batch-provider)
[`init(array: [any MLFeatureProvider])`](https://developer.apple.com/documentation/coreml/mlarraybatchprovider/init\(array:\))
Creates the batch provider based on the array of feature providers.
[`init(dictionary: [String : [Any]]) throws`](https://developer.apple.com/documentation/coreml/mlarraybatchprovider/init\(dictionary:\))
Creates a batch provider based on feature names and their associated arrays of data.
### [Accessing the feature providers](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#Accessing-the-feature-providers)
[`var array: [any MLFeatureProvider]`](https://developer.apple.com/documentation/coreml/mlarraybatchprovider/array)
The array of feature providers.
## [Relationships](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#relationships)
### [Inherits From](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#see-also)
### [Model inputs and outputs](https://developer.apple.com/documentation/CoreML/MLArrayBatchProvider#Model-inputs-and-outputs)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FCoreML%2FMLArrayBatchProvider).
