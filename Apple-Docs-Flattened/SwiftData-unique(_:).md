Source: https://developer.apple.com/documentation/SwiftData/Unique(_:)

[ Skip Navigation ](https://developer.apple.com/documentation/SwiftData/Unique\(_:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/SwiftData/Unique\(_:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/SwiftData/Unique\(_:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/SwiftData/Unique\(_:\))
  * SwiftLanguage: Swift
...
macro Unique<T>(_ constraints: [[PartialKeyPath](https://developer.apple.com/documentation/Swift/PartialKeyPath)<T>]...) where T : [PersistentModel](https://developer.apple.com/documentation/swiftdata/persistentmodel)
```

## [ Parameters ](https://developer.apple.com/documentation/SwiftData/Unique\(_:\)#parameters) 

`constraints`
    
Arrays of model key-paths that form the unique constraints to apply to the enclosing model.
## [Overview](https://developer.apple.com/documentation/SwiftData/Unique\(_:\)#overview)
...
## [See Also](https://developer.apple.com/documentation/SwiftData/Unique\(_:\)#see-also)
### [Model definition](https://developer.apple.com/documentation/SwiftData/Unique\(_:\)#Model-definition)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSwiftData%2FUnique\(_%3A\)).
