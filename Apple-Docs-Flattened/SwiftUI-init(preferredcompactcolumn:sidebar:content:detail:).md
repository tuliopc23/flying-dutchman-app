...
[ Skip Navigation ](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\))
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 12 symbols inside 1779903131 
Creating a navigation split view
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 12 symbols inside 1779903131 [init(sidebar: () -> Sidebar, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(sidebar:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 12 symbols inside 1779903131 [init(sidebar: () -> Sidebar, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(sidebar:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 12 symbols inside 1779903131 [init(sidebar: () -> Sidebar, content: () -> Content, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(sidebar:content:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
Navigator is ready 
  ...
  * [ init(preferredCompactColumn:sidebar:content:detail:) ](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\))
  *     * [ NavigationSplitView ](https://developer.apple.com/documentation/swiftui/navigationsplitview)
...
## [ Parameters ](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\)#parameters) 
...
## [See Also](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\)#see-also)
### [Specifying a preferred compact column](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\)#Specifying-a-preferred-compact-column)
[`init(preferredCompactColumn: Binding<NavigationSplitViewColumn>, sidebar: () -> Sidebar, detail: () -> Detail)`](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:detail:\))
...
Current page is init(preferredCompactColumn:sidebar:content:detail:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fswiftui%2Fnavigationsplitview%2Finit\(preferredcompactcolumn%3Asidebar%3Acontent%3Adetail%3A\)).
