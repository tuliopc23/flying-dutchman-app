Source: https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue(for:)

[ Skip Navigation ](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\))
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\))


[](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\))
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 4 symbols inside -249587991 
Handling File Promises
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 4 symbols inside -249587991 [func filePromiseProvider(NSFilePromiseProvider, fileNameForType: String) -> String](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/filepromiseprovider\(_:filenamefortype:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 4 symbols inside -249587991 [func filePromiseProvider(NSFilePromiseProvider, writePromiseTo: URL, completionHandler: ((any Error)?) -> Void)](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/filepromiseprovider\(_:writepromiseto:completionhandler:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
4 of 4 symbols inside -249587991 [func operationQueue(for: NSFilePromiseProvider) -> OperationQueue](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
Navigator is ready 
  ...
  * [ operationQueue(for:) ](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\))
  *     * [ NSFilePromiseProviderDelegate ](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate)
    * operationQueue(for:) 
...
optional func operationQueue(for filePromiseProvider: [NSFilePromiseProvider](https://developer.apple.com/documentation/appkit/nsfilepromiseprovider)) -> [OperationQueue](https://developer.apple.com/documentation/Foundation/OperationQueue)
```

## [ Parameters ](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\)#parameters) 

`filePromiseProvider`
    
The file promise provider for the operation queue.
## [Discussion](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\)#Discussion)
...
## [See Also](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\)#see-also)
### [Handling File Promises](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/operationqueue\(for:\)#Handling-File-Promises)
[`func filePromiseProvider(NSFilePromiseProvider, fileNameForType: String) -> String`](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/filepromiseprovider\(_:filenamefortype:\))
Provides the drag destination file’s name.
**Required**
[`func filePromiseProvider(NSFilePromiseProvider, writePromiseTo: URL, completionHandler: ((any Error)?) -> Void)`](https://developer.apple.com/documentation/appkit/nsfilepromiseproviderdelegate/filepromiseprovider\(_:writepromiseto:completionhandler:\))
Writes the contents of a promise to the specified URL.
**Required**
Current page is operationQueue(for:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fappkit%2Fnsfilepromiseproviderdelegate%2Foperationqueue\(for%3A\)).
