...
[ Skip Navigation ](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app)
...
[ Download ](https://docs-assets.developer.apple.com/published/e845680c042f/AddingContextMenusInYourApp.zip)
iOS 14.0+iPadOS 14.0+Xcode 12.0+
## [Overview](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Overview)
...
### [Create a context menu](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Create-a-context-menu)
...
Adopt `UIContextMenuInteractionDelegate` to manage the lifecycle of context menus. The app implements [`contextMenuInteraction(_:configurationForMenuAtLocation:)`](https://developer.apple.com/documentation/uikit/uicontextmenuinteractiondelegate/contextmenuinteraction\(_:configurationformenuatlocation:\)) to return a `UIContextMenuConfiguration` object. This configuration object consists of an optional `identifier`, a `previewProvider` that returns a [`UIViewController`](https://developer.apple.com/documentation/uikit/uiviewcontroller), and an `actionProvider` that returns a [`UIMenu`](https://developer.apple.com/documentation/uikit/uimenu) with a set of [`UIAction`](https://developer.apple.com/documentation/uikit/uiaction) items.
Context menus with rich content also provide a [`UITargetedPreview`](https://developer.apple.com/documentation/uikit/uitargetedpreview), an object that describes the source view when opening and animating the contextual menu. A `UITargetedPreview` specifies the view to use during animated transitions.
### [Add a context menu to a view](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Add-a-context-menu-to-a-view)
...
### [Add a context menu to a table view](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Add-a-context-menu-to-a-table-view)
...
### [Add a context menu to a collection view](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Add-a-context-menu-to-a-collection-view)
...
### [Add a context menu to a control](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Add-a-context-menu-to-a-control)
...
### [Add a context menu to a web view](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Add-a-context-menu-to-a-web-view)
...
## [See Also](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#see-also)
### [Creating a context menu interaction object](https://developer.apple.com/documentation/UIKit/adding-context-menus-in-your-app#Creating-a-context-menu-interaction-object)
[`init(delegate: any UIContextMenuInteractionDelegate)`](https://developer.apple.com/documentation/uikit/uicontextmenuinteraction/init\(delegate:\))
...
Current page is Adding context menus in your app 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FUIKit%2Fadding-context-menus-in-your-app).
