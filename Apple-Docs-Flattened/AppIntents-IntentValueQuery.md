Source: https://developer.apple.com/documentation/appintents/intentvaluequery

[ Skip Navigation ](https://developer.apple.com/documentation/appintents/intentvaluequery#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appintents/intentvaluequery#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appintents/intentvaluequery)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appintents/intentvaluequery)
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 8 symbols inside 1714315902 
Associated Types
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
2 of 8 symbols inside 1714315902 [Input](https://developer.apple.com/documentation/appintents/intentvaluequery/input)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
3 of 8 symbols inside 1714315902 [Result](https://developer.apple.com/documentation/appintents/intentvaluequery/result)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
4 of 8 symbols inside 1714315902 [ResultValue](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
5 of 8 symbols inside 1714315902 
Initializers
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
6 of 8 symbols inside 1714315902 [init()](https://developer.apple.com/documentation/appintents/intentvaluequery/init\(\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
7 of 8 symbols inside 1714315902 
Instance Methods
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
8 of 8 symbols inside 1714315902 [func values(for: Self.Input) async throws -> Self.Result](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
```
protocol IntentValueQuery : [PersistentlyIdentifiable](https://developer.apple.com/documentation/appintents/persistentlyidentifiable), _SupportsAppDependencies, [Sendable](https://developer.apple.com/documentation/Swift/Sendable)
```

## [Topics](https://developer.apple.com/documentation/appintents/intentvaluequery#topics)
### [Associated Types](https://developer.apple.com/documentation/appintents/intentvaluequery#Associated-Types)
[`associatedtype Input : _IntentValue`](https://developer.apple.com/documentation/appintents/intentvaluequery/input)
**Required**
[`associatedtype Result : ResultsCollection = [Self.ResultValue]`](https://developer.apple.com/documentation/appintents/intentvaluequery/result)
**Required**
[`associatedtype ResultValue = Self.Result.Result.ValueType`](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue)
**Required**
### [Initializers](https://developer.apple.com/documentation/appintents/intentvaluequery#Initializers)
[`init()`](https://developer.apple.com/documentation/appintents/intentvaluequery/init\(\))
**Required**
### [Instance Methods](https://developer.apple.com/documentation/appintents/intentvaluequery#Instance-Methods)
[`func values(for: Self.Input) async throws -> Self.Result`](https://developer.apple.com/documentation/appintents/intentvaluequery/values\(for:\))
**Required**
## [Relationships](https://developer.apple.com/documentation/appintents/intentvaluequery#relationships)
### [Inherits From](https://developer.apple.com/documentation/appintents/intentvaluequery#inherits-from)
...
## [See Also](https://developer.apple.com/documentation/appintents/intentvaluequery#see-also)
### [Visual intelligence](https://developer.apple.com/documentation/appintents/intentvaluequery#Visual-intelligence)
...
Current page is IntentValueQuery 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fappintents%2Fintentvaluequery).
