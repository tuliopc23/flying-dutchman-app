Source: https://developer.apple.com/documentation/appkit/nsapplication/shared

[ Skip Navigation ](https://developer.apple.com/documentation/appkit/nsapplication/shared#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appkit/nsapplication/shared#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appkit/nsapplication/shared)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appkit/nsapplication/shared)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/appkit/nsapplication/shared)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
10 of 120 symbols inside -1817745663 [var currentEvent: NSEvent?](https://developer.apple.com/documentation/appkit/nsapplication/currentevent)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
11 of 120 symbols inside -1817745663 [var isRunning: Bool](https://developer.apple.com/documentation/appkit/nsapplication/isrunning)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
12 of 120 symbols inside -1817745663 [func run()](https://developer.apple.com/documentation/appkit/nsapplication/run\(\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
13 of 120 symbols inside -1817745663 [func finishLaunching()](https://developer.apple.com/documentation/appkit/nsapplication/finishlaunching\(\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
14 of 120 symbols inside -1817745663 [func stop(Any?)](https://developer.apple.com/documentation/appkit/nsapplication/stop\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
15 of 120 symbols inside -1817745663 [func sendEvent(NSEvent)](https://developer.apple.com/documentation/appkit/nsapplication/sendevent\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
16 of 120 symbols inside -1817745663 [func postEvent(NSEvent, atStart: Bool)](https://developer.apple.com/documentation/appkit/nsapplication/postevent\(_:atstart:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
17 of 120 symbols inside -1817745663 
Posting actions
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
18 of 120 symbols inside -1817745663 [func tryToPerform(Selector, with: Any?) -> Bool](https://developer.apple.com/documentation/appkit/nsapplication/trytoperform\(_:with:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
19 of 120 symbols inside -1817745663 [func sendAction(Selector, to: Any?, from: Any?) -> Bool](https://developer.apple.com/documentation/appkit/nsapplication/sendaction\(_:to:from:\))
...
Navigator is ready 
  ...
  * [ shared ](https://developer.apple.com/documentation/appkit/nsapplication/shared)
  *     * [ NSApplication ](https://developer.apple.com/documentation/appkit/nsapplication)
    * shared 
...
class var shared: [NSApplication](https://developer.apple.com/documentation/appkit/nsapplication) { get }
```

## [Return Value](https://developer.apple.com/documentation/appkit/nsapplication/shared#return-value)
The shared application object.
## [ Mentioned in ](https://developer.apple.com/documentation/appkit/nsapplication/shared#mentions)
[](https://developer.apple.com/documentation/appkit/passing-control-from-one-app-to-another-with-cooperative-activation)
## [Discussion](https://developer.apple.com/documentation/appkit/nsapplication/shared#Discussion)
This method also makes a connection to the window server and completes other initialization. Your program should invoke this method as one of the first statements in `main()`; this invoking is done for you if you create your application with Xcode. To retrieve the `NSApplication` instance after it has been created, use the global variable [`NSApp`](https://developer.apple.com/documentation/appkit/nsapp) or invoke this method.
## [See Also](https://developer.apple.com/documentation/appkit/nsapplication/shared#see-also)
### [Related Documentation](https://developer.apple.com/documentation/appkit/nsapplication/shared#Related-Documentation)
...
### [Getting the shared app object](https://developer.apple.com/documentation/appkit/nsapplication/shared#Getting-the-shared-app-object)
