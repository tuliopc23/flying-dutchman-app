Source: https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection

[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 4 symbols inside -1092450532 
Accessing synchronized data
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 4 symbols inside -1092450532 [var count: Int](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection/count)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 4 symbols inside -1092450532 [func synchronizedData(for: AVCaptureOutput) -> AVCaptureSynchronizedData?](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection/synchronizeddata\(for:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
4 of 4 symbols inside -1092450532 [subscript(AVCaptureOutput) -> AVCaptureSynchronizedData?](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection/subscript\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
Navigator is ready 
  * [ AVFoundation ](https://developer.apple.com/documentation/avfoundation)
  * [ AVCaptureSynchronizedDataCollection ](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection)
...
## [Topics](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#topics)
### [Accessing synchronized data](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#Accessing-synchronized-data)
[`var count: Int`](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection/count)
The number of synchronized data objects in the collection.
[`func synchronizedData(for: AVCaptureOutput) -> AVCaptureSynchronizedData?`](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection/synchronizeddata\(for:\))
Returns synchronized data captured by the specified capture output.
[`subscript(AVCaptureOutput) -> AVCaptureSynchronizedData?`](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection/subscript\(_:\))
Returns data captured by the specified capture output, using subscript syntax.
## [Relationships](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#relationships)
### [Inherits From](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#see-also)
### [Synchronized capture](https://developer.apple.com/documentation/avfoundation/avcapturesynchronizeddatacollection#Synchronized-capture)
...
Current page is AVCaptureSynchronizedDataCollection 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Favcapturesynchronizeddatacollection).
