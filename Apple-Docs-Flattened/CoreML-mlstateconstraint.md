Source: https://developer.apple.com/documentation/coreml/mlstateconstraint

[ Skip Navigation ](https://developer.apple.com/documentation/coreml/mlstateconstraint#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/coreml/mlstateconstraint#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/coreml/mlstateconstraint)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/coreml/mlstateconstraint)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/coreml/mlstateconstraint)


[](https://developer.apple.com/documentation/coreml/mlstateconstraint)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
35 of 54 symbols inside <root>
Model state
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
36 of 54 symbols inside <root> containing 3 symbols[MLState](https://developer.apple.com/documentation/coreml/mlstate)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
37 of 54 symbols inside <root> containing 3 symbols[MLStateConstraint](https://developer.apple.com/documentation/coreml/mlstateconstraint)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 3 symbols inside -1599379526 
Inspecting a state constraint
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 3 symbols inside -1599379526 [var bufferShape: [Int]](https://developer.apple.com/documentation/coreml/mlstateconstraint/buffershape-4zb3w)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
3 of 3 symbols inside -1599379526 [var dataType: MLMultiArrayDataType](https://developer.apple.com/documentation/coreml/mlstateconstraint/datatype)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
38 of 54 symbols inside <root>
Model tensor
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
39 of 54 symbols inside <root> containing 160 symbols[MLTensor](https://developer.apple.com/documentation/coreml/mltensor)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
V
50 of 54 symbols inside <root> [let MLModelErrorDomain: String](https://developer.apple.com/documentation/coreml/mlmodelerrordomain)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
51 of 54 symbols inside <root>
Model deployments
57 items were found. Tab back to navigate through them. 
/ 
Navigator is ready 
  * [ Core ML ](https://developer.apple.com/documentation/coreml)
  * [ MLStateConstraint ](https://developer.apple.com/documentation/coreml/mlstateconstraint)
  *     * MLStateConstraint 
...
## [Topics](https://developer.apple.com/documentation/coreml/mlstateconstraint#topics)
### [Inspecting a state constraint](https://developer.apple.com/documentation/coreml/mlstateconstraint#Inspecting-a-state-constraint)
[`var bufferShape: [Int]`](https://developer.apple.com/documentation/coreml/mlstateconstraint/buffershape-4zb3w)
The shape of the state buffer.
[`var dataType: MLMultiArrayDataType`](https://developer.apple.com/documentation/coreml/mlstateconstraint/datatype)
The data type of scalars in the state buffer.
## [Relationships](https://developer.apple.com/documentation/coreml/mlstateconstraint#relationships)
### [Inherits From](https://developer.apple.com/documentation/coreml/mlstateconstraint#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/coreml/mlstateconstraint#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/coreml/mlstateconstraint#see-also)
### [Model state](https://developer.apple.com/documentation/coreml/mlstateconstraint#Model-state)
[`class MLState`](https://developer.apple.com/documentation/coreml/mlstate)
Handle to the state buffers.
Current page is MLStateConstraint 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fcoreml%2Fmlstateconstraint).
