...
[ Skip Navigation ](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\))
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
21 of 57 symbols inside -1763969586 
Continuations
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
...
Navigator is ready 
  * [ Swift ](https://developer.apple.com/documentation/swift)
  * [ withDiscardingTaskGroup(returning:isolation:body:) ](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\))
...
func withDiscardingTaskGroup<GroupResult>(
    ...
    isolation: isolated (any [Actor](https://developer.apple.com/documentation/swift/actor))? = #isolation,
    body: (inout [DiscardingTaskGroup](https://developer.apple.com/documentation/swift/discardingtaskgroup)) async -> GroupResult
) async -> GroupResult
```

## [Discussion](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\)#discussion)
Unlike a [`TaskGroup`](https://developer.apple.com/documentation/swift/taskgroup), the child tasks as well as their results are discarded as soon as the tasks complete. This prevents the discarding task group from accumulating many results waiting to be consumed, and is best applied in situations where the result of a child task is some form of side-effect.
...
Refer to [`TaskGroup`](https://developer.apple.com/documentation/swift/taskgroup) documentation for detailed discussion of semantics shared between all task groups.
# [Task Group Cancellation](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\)#Task-Group-Cancellation)
You can cancel a task group and all of its child tasks by calling the [`cancelAll()`](https://developer.apple.com/documentation/swift/taskgroup/cancelall\(\)) method on the task group, or by canceling the task in which the group is running.
...
## [See Also](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\)#see-also)
### [Tasks](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\)#Tasks)
[`struct Task`](https://developer.apple.com/documentation/swift/task)
A unit of asynchronous work.
[`struct TaskGroup`](https://developer.apple.com/documentation/swift/taskgroup)
A group that contains dynamically created child tasks.
[`func withTaskGroup<ChildTaskResult, GroupResult>(of: ChildTaskResult.Type, returning: GroupResult.Type, isolation: isolated (any Actor)?, body: (inout TaskGroup<ChildTaskResult>) async -> GroupResult) async -> GroupResult`](https://developer.apple.com/documentation/swift/withtaskgroup\(of:returning:isolation:body:\))
Starts a new scope that can contain a dynamic number of child tasks.
[`struct ThrowingTaskGroup`](https://developer.apple.com/documentation/swift/throwingtaskgroup)
A group that contains throwing, dynamically created child tasks.
[`func withThrowingTaskGroup<ChildTaskResult, GroupResult>(of: ChildTaskResult.Type, returning: GroupResult.Type, isolation: isolated (any Actor)?, body: (inout ThrowingTaskGroup<ChildTaskResult, any Error>) async throws -> GroupResult) async rethrows -> GroupResult`](https://developer.apple.com/documentation/swift/withthrowingtaskgroup\(of:returning:isolation:body:\))
Starts a new scope that can contain a dynamic number of throwing child tasks.
[`struct TaskPriority`](https://developer.apple.com/documentation/swift/taskpriority)
The priority of a task.
[`struct DiscardingTaskGroup`](https://developer.apple.com/documentation/swift/discardingtaskgroup)
A discarding group that contains dynamically created child tasks.
[`struct ThrowingDiscardingTaskGroup`](https://developer.apple.com/documentation/swift/throwingdiscardingtaskgroup)
A throwing discarding group that contains dynamically created child tasks.
[`func withThrowingDiscardingTaskGroup<GroupResult>(returning: GroupResult.Type, isolation: isolated (any Actor)?, body: (inout ThrowingDiscardingTaskGroup<any Error>) async throws -> GroupResult) async throws -> GroupResult`](https://developer.apple.com/documentation/swift/withthrowingdiscardingtaskgroup\(returning:isolation:body:\))
Starts a new scope that can contain a dynamic number of child tasks.
[`struct UnsafeCurrentTask`](https://developer.apple.com/documentation/swift/unsafecurrenttask)
An unsafe reference to the current task.
Current page is withDiscardingTaskGroup(returning:isolation:body:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fswift%2Fwithdiscardingtaskgroup\(returning%3Aisolation%3Abody%3A\)).
