Source: https://developer.apple.com/documentation/AppIntents/intent-discovery

[ Skip Navigation ](https://developer.apple.com/documentation/AppIntents/intent-discovery#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/AppIntents/intent-discovery#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/AppIntents/intent-discovery)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/AppIntents/intent-discovery)
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/AppIntents/intent-discovery)
...
## [Overview](https://developer.apple.com/documentation/AppIntents/intent-discovery#Overview)
...
## [Topics](https://developer.apple.com/documentation/AppIntents/intent-discovery#topics)
### [Donation management](https://developer.apple.com/documentation/AppIntents/intent-discovery#Donation-management)
[`struct IntentDonationManager`](https://developer.apple.com/documentation/appintents/intentdonationmanager)
A type you use to donate intents to the system, or delete intents when they become irrelevant.
[`struct IntentDonationIdentifier`](https://developer.apple.com/documentation/appintents/intentdonationidentifier)
An opaque type that identifies a specific donation to the system.
[`struct IntentDonationMatchingPredicate`](https://developer.apple.com/documentation/appintents/intentdonationmatchingpredicate)
The match conditions that identify a set of previously donated app intents.
### [Intent predictions](https://developer.apple.com/documentation/AppIntents/intent-discovery#Intent-predictions)
[`protocol PredictableIntent`](https://developer.apple.com/documentation/appintents/predictableintent)
An interface that allows the system to suggest the app intent to someone in the future using predictions you provide.
[`struct IntentPrediction`](https://developer.apple.com/documentation/appintents/intentprediction)
A prediction for a specific app intent that the system might display to someone when it’s relevant.
### [Intent relevancy](https://developer.apple.com/documentation/AppIntents/intent-discovery#Intent-relevancy)
...
## [See Also](https://developer.apple.com/documentation/AppIntents/intent-discovery#see-also)
### [Actions](https://developer.apple.com/documentation/AppIntents/intent-discovery#Actions)
...
Current page is Intent discovery 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FAppIntents%2Fintent-discovery).
