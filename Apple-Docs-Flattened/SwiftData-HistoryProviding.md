Source: https://developer.apple.com/documentation/SwiftData/HistoryProviding

[ Skip Navigation ](https://developer.apple.com/documentation/SwiftData/HistoryProviding#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/SwiftData/HistoryProviding#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/SwiftData/HistoryProviding)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/SwiftData/HistoryProviding)
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 8 symbols inside -1181820037 
Processing history fetch requests
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 8 symbols inside -1181820037 [func fetchHistory(HistoryDescriptor<Self.HistoryType>) throws -> [Self.HistoryType]](https://developer.apple.com/documentation/swiftdata/historyproviding/fetchhistory\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 8 symbols inside -1181820037 
Deleting history
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
4 of 8 symbols inside -1181820037 [func deleteHistory(HistoryDescriptor<Self.HistoryType>) throws](https://developer.apple.com/documentation/swiftdata/historyproviding/deletehistory\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
5 of 8 symbols inside -1181820037 
Getting the history transaction type
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
6 of 8 symbols inside -1181820037 [HistoryType](https://developer.apple.com/documentation/swiftdata/historyproviding/historytype-swift.associatedtype)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
7 of 8 symbols inside -1181820037 
Type Properties
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
8 of 8 symbols inside -1181820037 [static var historyType: Self.HistoryType.Type](https://developer.apple.com/documentation/swiftdata/historyproviding/historytype-swift.type.property)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
## [Topics](https://developer.apple.com/documentation/SwiftData/HistoryProviding#topics)
### [Processing history fetch requests](https://developer.apple.com/documentation/SwiftData/HistoryProviding#Processing-history-fetch-requests)
[`func fetchHistory(HistoryDescriptor<Self.HistoryType>) throws -> [Self.HistoryType]`](https://developer.apple.com/documentation/swiftdata/historyproviding/fetchhistory\(_:\))
**Required**
### [Deleting history](https://developer.apple.com/documentation/SwiftData/HistoryProviding#Deleting-history)
[`func deleteHistory(HistoryDescriptor<Self.HistoryType>) throws`](https://developer.apple.com/documentation/swiftdata/historyproviding/deletehistory\(_:\))
**Required**
### [Getting the history transaction type](https://developer.apple.com/documentation/SwiftData/HistoryProviding#Getting-the-history-transaction-type)
[`associatedtype HistoryType : HistoryTransaction`](https://developer.apple.com/documentation/swiftdata/historyproviding/historytype-swift.associatedtype)
**Required**
### [Type Properties](https://developer.apple.com/documentation/SwiftData/HistoryProviding#Type-Properties)
[`static var historyType: Self.HistoryType.Type`](https://developer.apple.com/documentation/swiftdata/historyproviding/historytype-swift.type.property)
**Required**
## [Relationships](https://developer.apple.com/documentation/SwiftData/HistoryProviding#relationships)
### [Conforming Types](https://developer.apple.com/documentation/SwiftData/HistoryProviding#conforming-types)
  * [`DefaultStore`](https://developer.apple.com/documentation/swiftdata/defaultstore)


## [See Also](https://developer.apple.com/documentation/SwiftData/HistoryProviding#see-also)
### [Model storage](https://developer.apple.com/documentation/SwiftData/HistoryProviding#Model-storage)
...
Current page is HistoryProviding 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSwiftData%2FHistoryProviding).
