Source: https://developer.apple.com/documentation/Security/SecItemAdd(_:_:)

[ Skip Navigation ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\))
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\))
...
Navigator is ready 
  * [ Security ](https://developer.apple.com/documentation/security)
  * [ SecItemAdd(_:_:) ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\))
  *     * SecItemAdd(_:_:) 
...
func SecItemAdd(
    ...
    _ result: [UnsafeMutablePointer](https://developer.apple.com/documentation/Swift/UnsafeMutablePointer)<[CFTypeRef](https://developer.apple.com/documentation/CoreFoundation/CFTypeRef)?>?
) -> OSStatus
```

## [ Parameters ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#parameters) 
...
A dictionary that describes the item to add. A typical `attributes` dictionary consists of:
  ...
  * **Optional return types.** Include return type keys to indicate what data, if any, you want returned upon successful completion. You often ignore the return data from a [`SecItemAdd(_:_:)`](https://developer.apple.com/documentation/security/secitemadd\(_:_:\)) call, in which case you don’t need to include any return result key. See [Item return result keys](https://developer.apple.com/documentation/security/item-return-result-keys) for more information.



`result`
    
On return, a reference to the newly added items. The exact type of the result is based on the values supplied in `attributes`, as discussed in [Item return result keys](https://developer.apple.com/documentation/security/item-return-result-keys). Pass `nil` if you don’t need the result. Otherwise, your app becomes responsible for releasing the referenced object.
## [Return Value](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#return-value)
...
## [ Mentioned in ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#mentions)
...
[](https://developer.apple.com/documentation/security/storing-a-certificate-in-the-keychain)
...
## [Discussion](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#Discussion)
...
### [Performance considerations](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\)#Performance-considerations)
`SecItemAdd` blocks the calling thread, so it can cause your app’s UI to hang if called from the main thread. Instead, call `SecItemAdd` from a background dispatch queue or `async` function:
  * [ Swift ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\))
  * [ Objective-C ](https://developer.apple.com/documentation/Security/SecItemAdd\(_:_:\))
...
Current page is SecItemAdd(_:_:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSecurity%2FSecItemAdd\(_%3A_%3A\)).
