...
[ Skip Navigation ](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor)
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 5 symbols inside -226114625 
Creating a delegate adaptor
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 5 symbols inside -226114625 [init(_:)](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor/init\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 5 symbols inside -226114625 
Getting the delegate adaptor
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
4 of 5 symbols inside -226114625 [var projectedValue: ObservedObject<DelegateType>.Wrapper](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor/projectedvalue)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
5 of 5 symbols inside -226114625 [var wrappedValue: DelegateType](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor/wrappedvalue)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
struct NSApplicationDelegateAdaptor<DelegateType> where DelegateType : [NSObject](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class), DelegateType : [NSApplicationDelegate](https://developer.apple.com/documentation/AppKit/NSApplicationDelegate)
```

## [ Mentioned in ](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#mentions)
[](https://developer.apple.com/documentation/swiftui/migrating-to-the-swiftui-life-cycle)
## [Overview](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#overview)
...
## [Topics](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#topics)
### [Creating a delegate adaptor](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#Creating-a-delegate-adaptor)
[`init(_:)`](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor/init\(_:\))
Creates an AppKit app delegate adaptor using an observable delegate.
### [Getting the delegate adaptor](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#Getting-the-delegate-adaptor)
[`var projectedValue: ObservedObject<DelegateType>.Wrapper`](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor/projectedvalue)
A projection of the observed object that provides bindings to its properties.
[`var wrappedValue: DelegateType`](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor/wrappedvalue)
The underlying delegate.
## [Relationships](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#relationships)
### [Conforms To](https://developer.apple.com/documentation/swiftui/nsapplicationdelegateadaptor#conforms-to)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fswiftui%2Fnsapplicationdelegateadaptor).
