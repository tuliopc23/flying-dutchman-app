Source: https://developer.apple.com/documentation/security/randomization-services

[ Skip Navigation ](https://developer.apple.com/documentation/security/randomization-services#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/security/randomization-services#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/security/randomization-services)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/security/randomization-services)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/security/randomization-services)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 4 symbols inside -1541771605 
Random Numbers
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
2 of 4 symbols inside -1541771605 [func SecRandomCopyBytes(SecRandomRef?, Int, UnsafeMutableRawPointer) -> Int32](https://developer.apple.com/documentation/security/secrandomcopybytes\(_:_:_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
T
3 of 4 symbols inside -1541771605 [SecRandomRef](https://developer.apple.com/documentation/security/secrandomref)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
V
4 of 4 symbols inside -1541771605 [let kSecRandomDefault: SecRandomRef](https://developer.apple.com/documentation/security/ksecrandomdefault)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
44 of 65 symbols inside <root> containing 8 symbols[Security Functions](https://developer.apple.com/documentation/security/security-functions)
...
## [Overview](https://developer.apple.com/documentation/security/randomization-services#overview)
...
## [Topics](https://developer.apple.com/documentation/security/randomization-services#topics)
### [Random Numbers](https://developer.apple.com/documentation/security/randomization-services#Random-Numbers)
[`func SecRandomCopyBytes(SecRandomRef?, Int, UnsafeMutableRawPointer) -> Int32`](https://developer.apple.com/documentation/security/secrandomcopybytes\(_:_:_:\))
Generates an array of cryptographically secure random bytes.
[`typealias SecRandomRef`](https://developer.apple.com/documentation/security/secrandomref)
An abstract Core Foundation-type object containing information about a random number generator.
[`let kSecRandomDefault: SecRandomRef`](https://developer.apple.com/documentation/security/ksecrandomdefault)
An alias for the default random number generator.
Current page is Randomization Services 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fsecurity%2Frandomization-services).
