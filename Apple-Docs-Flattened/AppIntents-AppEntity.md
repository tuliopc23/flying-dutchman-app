...
[ Skip Navigation ](https://developer.apple.com/documentation/appintents/appentity#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appintents/appentity#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appintents/appentity)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appintents/appentity)
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
35 of 63 symbols inside <root> containing 35 symbols[App entities](https://developer.apple.com/documentation/appintents/app-entities)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 35 symbols inside -631263582 
Entities
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
2 of 35 symbols inside -631263582 [Integrating custom data types into your intents](https://developer.apple.com/documentation/appintents/integrating-custom-types-into-your-intents)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
3 of 35 symbols inside -631263582 containing 9 symbols[AppEntity](https://developer.apple.com/documentation/appintents/appentity)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 9 symbols inside 1921558192 
Specifying properties
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
T
2 of 9 symbols inside 1921558192 [AppEntity.Property](https://developer.apple.com/documentation/appintents/appentity/property)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 9 symbols inside 1921558192 
Making the entity queryable
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
4 of 9 symbols inside 1921558192 [static var defaultQuery: Self.DefaultQuery](https://developer.apple.com/documentation/appintents/appentity/defaultquery-4khg7)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
5 of 9 symbols inside 1921558192 [DefaultQuery](https://developer.apple.com/documentation/appintents/appentity/defaultquery-swift.associatedtype)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
6 of 9 symbols inside 1921558192 [static var defaultResolverSpecification: EmptyResolverSpecification<Self>](https://developer.apple.com/documentation/appintents/appentity/defaultresolverspecification-2dpf2)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
7 of 9 symbols inside 1921558192 [static var defaultResolverSpecification: some ResolverSpecification](https://developer.apple.com/documentation/appintents/appentity/defaultresolverspecification-589eq)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
8 of 9 symbols inside 1921558192 
Default Implementations
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
9 of 9 symbols inside 1921558192 containing 2 symbols[Identifiable Implementations](https://developer.apple.com/documentation/appintents/appentity/identifiable-implementations)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
4 of 35 symbols inside -631263582 containing 2 symbols[FileEntity](https://developer.apple.com/documentation/appintents/fileentity)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
5 of 35 symbols inside -631263582 containing 4 symbols[IndexedEntity](https://developer.apple.com/documentation/appintents/indexedentity)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
6 of 35 symbols inside -631263582 containing 2 symbols[TransientAppEntity](https://developer.apple.com/documentation/appintents/transientappentity)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
7 of 35 symbols inside -631263582 [UniqueAppEntity](https://developer.apple.com/documentation/appintents/uniqueappentity)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
8 of 35 symbols inside -631263582 containing 4 symbols[URLRepresentableEntity](https://developer.apple.com/documentation/appintents/urlrepresentableentity)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
9 of 35 symbols inside -631263582 
Entity identity
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
10 of 35 symbols inside -631263582 containing 2 symbols[PersistentlyIdentifiable](https://developer.apple.com/documentation/appintents/persistentlyidentifiable)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
S
11 of 35 symbols inside -631263582 containing 14 symbols[EntityIdentifier](https://developer.apple.com/documentation/appintents/entityidentifier)
...
```
protocol AppEntity : [AppValue](https://developer.apple.com/documentation/appintents/appvalue), [DisplayRepresentable](https://developer.apple.com/documentation/appintents/displayrepresentable), [Identifiable](https://developer.apple.com/documentation/Swift/Identifiable) where Self == Self.ValueType, Self.[ID](https://developer.apple.com/documentation/Swift/Identifiable/ID-swift.associatedtype) : [EntityIdentifierConvertible](https://developer.apple.com/documentation/appintents/entityidentifierconvertible), Self.[ID](https://developer.apple.com/documentation/Swift/Identifiable/ID-swift.associatedtype) : [Sendable](https://developer.apple.com/documentation/Swift/Sendable)
```

## [ Mentioned in ](https://developer.apple.com/documentation/appintents/appentity#mentions)
...
## [Overview](https://developer.apple.com/documentation/appintents/appentity#overview)
To use a data model object to app intents, update it to conform to the `AppEntity` protocol. Declare properties using the `@Property` property wrapper to make them visible to the system. The following example from the [Accelerating app interactions with App Intents](https://developer.apple.com/documentation/appintents/acceleratingappinteractionswithappintents) sample app shows a data model for a trail:
```
...
For additional property types, see [`EntityProperty`](https://developer.apple.com/documentation/appintents/entityproperty).
...
## [Topics](https://developer.apple.com/documentation/appintents/appentity#topics)
### [Specifying properties](https://developer.apple.com/documentation/appintents/appentity#Specifying-properties)
[`typealias Property`](https://developer.apple.com/documentation/appintents/appentity/property)
### [Making the entity queryable](https://developer.apple.com/documentation/appintents/appentity#Making-the-entity-queryable)
[`static var defaultQuery: Self.DefaultQuery`](https://developer.apple.com/documentation/appintents/appentity/defaultquery-4khg7)
The default query to use to retrieve entity property instances.
**Required** Default implementations provided. 
[`associatedtype DefaultQuery : EntityQuery`](https://developer.apple.com/documentation/appintents/appentity/defaultquery-swift.associatedtype)
**Required**
[`static var defaultResolverSpecification: EmptyResolverSpecification<Self>`](https://developer.apple.com/documentation/appintents/appentity/defaultresolverspecification-2dpf2)
[`static var defaultResolverSpecification: some ResolverSpecification`](https://developer.apple.com/documentation/appintents/appentity/defaultresolverspecification-589eq)
### [Default Implementations](https://developer.apple.com/documentation/appintents/appentity#Default-Implementations)
[API Reference Identifiable Implementations](https://developer.apple.com/documentation/appintents/appentity/identifiable-implementations)
## [Relationships](https://developer.apple.com/documentation/appintents/appentity#relationships)
### [Inherits From](https://developer.apple.com/documentation/appintents/appentity#inherits-from)
...
### [Inherited By](https://developer.apple.com/documentation/appintents/appentity#inherited-by)
...
## [See Also](https://developer.apple.com/documentation/appintents/appentity#see-also)
### [Entities](https://developer.apple.com/documentation/appintents/appentity#Entities)
...
[`protocol FileEntity`](https://developer.apple.com/documentation/appintents/fileentity)
An entity that refers to a document or other file.
[`protocol IndexedEntity`](https://developer.apple.com/documentation/appintents/indexedentity)
...
[`protocol TransientAppEntity`](https://developer.apple.com/documentation/appintents/transientappentity)
...
[`protocol UniqueAppEntity`](https://developer.apple.com/documentation/appintents/uniqueappentity)
An entity that will only ever have one value, such as global settings.
[`protocol URLRepresentableEntity`](https://developer.apple.com/documentation/appintents/urlrepresentableentity)
An app entity with a URL representation.
Current page is AppEntity 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fappintents%2Fappentity).
