Source: https://developer.apple.com/documentation/createml/mldatatable/randomsplit(by:seed:)

[ Skip Navigation ](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\))
  * SwiftLanguage: Swift
...
```
func randomSplit(
    by proportion: [Double](https://developer.apple.com/documentation/Swift/Double),
    seed: [Int](https://developer.apple.com/documentation/Swift/Int) = 1
) -> ([MLDataTable](https://developer.apple.com/documentation/createml/mldatatable), [MLDataTable](https://developer.apple.com/documentation/createml/mldatatable))
```

## [ Parameters ](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\)#parameters) 

`proportion`
    
A value between `0.0` and `1.0` indicating the fraction of rows to go into one subset. The remaining rows go into the other subset. 

`seed`
    
A random number generator seed. The default value is `1`.
## [Return Value](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\)#return-value)
Two new data tables.
## [ Mentioned in ](https://developer.apple.com/documentation/createml/mldatatable/randomsplit\(by:seed:\)#mentions)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fcreateml%2Fmldatatable%2Frandomsplit\(by%3Aseed%3A\)).
