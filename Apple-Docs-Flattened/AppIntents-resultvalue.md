Source: https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue

[ Skip Navigation ](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue)
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue)
...
Navigator is ready 
  ...
  * [ ResultValue ](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue)
  *     * [ IntentValueQuery ](https://developer.apple.com/documentation/appintents/intentvaluequery)
    * ResultValue 
...
```
associatedtype ResultValue = Self.[Result](https://developer.apple.com/documentation/appintents/intentvaluequery/result).[Result](https://developer.apple.com/documentation/appintents/resultscollection/result).ValueType where Self.[ResultValue](https://developer.apple.com/documentation/appintents/intentvaluequery/resultvalue) == Self.[Result](https://developer.apple.com/documentation/appintents/intentvaluequery/result).[Result](https://developer.apple.com/documentation/appintents/resultscollection/result)
```

**Required**
Current page is ResultValue 
