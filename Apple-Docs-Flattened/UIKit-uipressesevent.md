Source: https://developer.apple.com/documentation/uikit/uipressesevent

[ Skip Navigation ](https://developer.apple.com/documentation/uikit/uipressesevent#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/uikit/uipressesevent#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/uikit/uipressesevent)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/uikit/uipressesevent)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/uikit/uipressesevent)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 3 symbols inside 668111730 
Reading the event button presses
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 3 symbols inside 668111730 [var allPresses: Set<UIPress>](https://developer.apple.com/documentation/uikit/uipressesevent/allpresses)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 3 symbols inside 668111730 [func presses(for: UIGestureRecognizer) -> Set<UIPress>](https://developer.apple.com/documentation/uikit/uipressesevent/presses\(for:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
Navigator is ready 
  * [ UIKit ](https://developer.apple.com/documentation/uikit)
  * [ UIPressesEvent ](https://developer.apple.com/documentation/uikit/uipressesevent)
  *     * UIPressesEvent 
...
## [Topics](https://developer.apple.com/documentation/uikit/uipressesevent#topics)
### [Reading the event button presses](https://developer.apple.com/documentation/uikit/uipressesevent#Reading-the-event-button-presses)
[`var allPresses: Set<UIPress>`](https://developer.apple.com/documentation/uikit/uipressesevent/allpresses)
The state of all physical buttons in the event.
[`func presses(for: UIGestureRecognizer) -> Set<UIPress>`](https://developer.apple.com/documentation/uikit/uipressesevent/presses\(for:\))
Returns the state of all physical buttons in the event that are associated with a particular gesture recognizer.
## [Relationships](https://developer.apple.com/documentation/uikit/uipressesevent#relationships)
### [Inherits From](https://developer.apple.com/documentation/uikit/uipressesevent#inherits-from)
  * [`UIEvent`](https://developer.apple.com/documentation/uikit/uievent)


### [Conforms To](https://developer.apple.com/documentation/uikit/uipressesevent#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/uikit/uipressesevent#see-also)
### [Button presses](https://developer.apple.com/documentation/uikit/uipressesevent#Button-presses)
[`class UIPress`](https://developer.apple.com/documentation/uikit/uipress)
An object that represents the presence or movement of a button press on the screen for a particular event.
Current page is UIPressesEvent 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fuikit%2Fuipressesevent).
