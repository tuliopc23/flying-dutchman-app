...
[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 4 symbols inside -1151111893 
Creating a sample reference output
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 4 symbols inside -1151111893 [init(track: AVAssetTrack)](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput/init\(track:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 4 symbols inside -1151111893 
Inspecting the track
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
4 of 4 symbols inside -1151111893 [var track: AVAssetTrack](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput/track)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
Navigator is ready 
  * [ AVFoundation ](https://developer.apple.com/documentation/avfoundation)
  * [ AVAssetReaderSampleReferenceOutput ](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput)
...
## [Overview](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#overview)
...
You can also append sample buffers that you extract using this class to an [`AVAssetWriterInput`](https://developer.apple.com/documentation/avfoundation/avassetwriterinput) instance to create movie tracks that aren’t self-contained and reference data in the original file instead. To write tracks that aren’t self-contained, use instances of [`AVAssetWriter`](https://developer.apple.com/documentation/avfoundation/avassetwriter) that you configure to write files of type [`mov`](https://developer.apple.com/documentation/avfoundation/avfiletype/mov).
...
## [Topics](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#topics)
### [Creating a sample reference output](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#Creating-a-sample-reference-output)
[`init(track: AVAssetTrack)`](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput/init\(track:\))
Creates an object that supplies sample references.
### [Inspecting the track](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#Inspecting-the-track)
[`var track: AVAssetTrack`](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput/track)
The track from which the output reads sample references.
## [Relationships](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#relationships)
### [Inherits From](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#inherits-from)
  * [`AVAssetReaderOutput`](https://developer.apple.com/documentation/avfoundation/avassetreaderoutput)


### [Conforms To](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#see-also)
### [Media reading](https://developer.apple.com/documentation/avfoundation/avassetreadersamplereferenceoutput#Media-reading)
...
Current page is AVAssetReaderSampleReferenceOutput 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Favassetreadersamplereferenceoutput).
