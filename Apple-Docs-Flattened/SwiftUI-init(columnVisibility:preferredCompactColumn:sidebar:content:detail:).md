...
[ Skip Navigation ](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\))
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
4 of 12 symbols inside 1779903131 
Hiding columns in a navigation split view
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
5 of 12 symbols inside 1779903131 [init(columnVisibility: Binding<NavigationSplitViewVisibility>, sidebar: () -> Sidebar, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(columnvisibility:sidebar:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
5 of 12 symbols inside 1779903131 [init(columnVisibility: Binding<NavigationSplitViewVisibility>, sidebar: () -> Sidebar, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(columnvisibility:sidebar:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
6 of 12 symbols inside 1779903131 [init(columnVisibility: Binding<NavigationSplitViewVisibility>, sidebar: () -> Sidebar, content: () -> Content, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(columnvisibility:sidebar:content:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
7 of 12 symbols inside 1779903131 
Specifying a preferred compact column
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
8 of 12 symbols inside 1779903131 [init(preferredCompactColumn: Binding<NavigationSplitViewColumn>, sidebar: () -> Sidebar, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
9 of 12 symbols inside 1779903131 [init(preferredCompactColumn: Binding<NavigationSplitViewColumn>, sidebar: () -> Sidebar, content: () -> Content, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(preferredcompactcolumn:sidebar:content:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
10 of 12 symbols inside 1779903131 
Specifying a preferred compact column and column visibility
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
11 of 12 symbols inside 1779903131 [init(columnVisibility: Binding<NavigationSplitViewVisibility>, preferredCompactColumn: Binding<NavigationSplitViewColumn>, sidebar: () -> Sidebar, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(columnvisibility:preferredcompactcolumn:sidebar:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
12 of 12 symbols inside 1779903131 [init(columnVisibility: Binding<NavigationSplitViewVisibility>, preferredCompactColumn: Binding<NavigationSplitViewColumn>, sidebar: () -> Sidebar, content: () -> Content, detail: () -> Detail)](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(columnvisibility:preferredcompactcolumn:sidebar:content:detail:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
20 of 65 symbols inside -1158154854 
Setting titles for navigation content
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
21 of 65 symbols inside -1158154854 [func navigationTitle(_:)](https://developer.apple.com/documentation/swiftui/view/navigationtitle\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
22 of 65 symbols inside -1158154854 [func navigationSubtitle(_:)](https://developer.apple.com/documentation/swiftui/view/navigationsubtitle\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
23 of 65 symbols inside -1158154854 [func navigationDocument(_:)](https://developer.apple.com/documentation/swiftui/view/navigationdocument\(_:\))
140 items were found. Tab back to navigate through them. 
/ 
Navigator is ready 
  * [ SwiftUI ](https://developer.apple.com/documentation/swiftui)
  * [ NavigationSplitView ](https://developer.apple.com/documentation/swiftui/navigationsplitview)
  * [ init(columnVisibility:preferredCompactColumn:sidebar:content:detail:) ](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\))
  *     * [ NavigationSplitView ](https://developer.apple.com/documentation/swiftui/navigationsplitview)
...
nonisolated
init(
    columnVisibility: [Binding](https://developer.apple.com/documentation/swiftui/binding)<[NavigationSplitViewVisibility](https://developer.apple.com/documentation/swiftui/navigationsplitviewvisibility)>,
    preferredCompactColumn: [Binding](https://developer.apple.com/documentation/swiftui/binding)<[NavigationSplitViewColumn](https://developer.apple.com/documentation/swiftui/navigationsplitviewcolumn)>,
    @[ViewBuilder](https://developer.apple.com/documentation/swiftui/viewbuilder) sidebar: () -> Sidebar,
    @[ViewBuilder](https://developer.apple.com/documentation/swiftui/viewbuilder) content: () -> Content,
    @[ViewBuilder](https://developer.apple.com/documentation/swiftui/viewbuilder) detail: () -> Detail
)
```

Available when `Sidebar` conforms to `View`, `Content` conforms to `View`, and `Detail` conforms to `View`.
## [ Parameters ](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\)#parameters) 

`columnVisibility`
    
A [`Binding`](https://developer.apple.com/documentation/swiftui/binding) to state that controls the visibility of the leading columns. 

`preferredCompactColumn`
    
A [`Binding`](https://developer.apple.com/documentation/swiftui/binding) to state that controls which column appears on top when the view collapses. 
...
## [See Also](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\)#see-also)
### [Specifying a preferred compact column and column visibility](https://developer.apple.com/documentation/SwiftUI/NavigationSplitView/init\(columnVisibility:preferredCompactColumn:sidebar:content:detail:\)#Specifying-a-preferred-compact-column-and-column-visibility)
[`init(columnVisibility: Binding<NavigationSplitViewVisibility>, preferredCompactColumn: Binding<NavigationSplitViewColumn>, sidebar: () -> Sidebar, detail: () -> Detail)`](https://developer.apple.com/documentation/swiftui/navigationsplitview/init\(columnvisibility:preferredcompactcolumn:sidebar:detail:\))
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSwiftUI%2FNavigationSplitView%2Finit\(columnVisibility%3ApreferredCompactColumn%3Asidebar%3Acontent%3Adetail%3A\)).
