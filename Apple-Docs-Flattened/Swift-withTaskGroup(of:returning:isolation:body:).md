...
[ Skip Navigation ](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\))
  * SwiftLanguage: Swift
...
func withTaskGroup<ChildTaskResult, GroupResult>(
    ...
    body: (inout [TaskGroup](https://developer.apple.com/documentation/swift/taskgroup)<ChildTaskResult>) async -> GroupResult
) async -> GroupResult where ChildTaskResult : [Sendable](https://developer.apple.com/documentation/swift/sendable)
```

## [Discussion](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\)#discussion)
...
## [See Also](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\)#see-also)
### [Tasks](https://developer.apple.com/documentation/Swift/withTaskGroup\(of:returning:isolation:body:\)#Tasks)
...
[`func withDiscardingTaskGroup<GroupResult>(returning: GroupResult.Type, isolation: isolated (any Actor)?, body: (inout DiscardingTaskGroup) async -> GroupResult) async -> GroupResult`](https://developer.apple.com/documentation/swift/withdiscardingtaskgroup\(returning:isolation:body:\))
Starts a new scope that can contain a dynamic number of child tasks.
...
Current page is withTaskGroup(of:returning:isolation:body:) 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FSwift%2FwithTaskGroup\(of%3Areturning%3Aisolation%3Abody%3A\)).
