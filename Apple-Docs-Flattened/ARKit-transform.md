Source: https://developer.apple.com/documentation/arkit/aranchor/transform

[ Skip Navigation ](https://developer.apple.com/documentation/arkit/aranchor/transform#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/arkit/aranchor/transform#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/arkit/aranchor/transform)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/arkit/aranchor/transform)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/arkit/aranchor/transform)
...
Navigator is ready 
  ...
  * [ transform ](https://developer.apple.com/documentation/arkit/aranchor/transform)
  *     * [ ARAnchor ](https://developer.apple.com/documentation/arkit/aranchor)
    * transform 
...
```
var transform: [simd_float4x4](https://developer.apple.com/documentation/simd/simd_float4x4) { get }
```

## [ Mentioned in ](https://developer.apple.com/documentation/arkit/aranchor/transform#mentions)
[](https://developer.apple.com/documentation/arkit/displaying-an-ar-experience-with-metal)
## [Discussion](https://developer.apple.com/documentation/arkit/aranchor/transform#Discussion)
World coordinate space in ARKit always follows a right-handed convention, but is oriented based on the session configuration. For details, see [Understanding World Tracking](https://developer.apple.com/documentation/arkit/understanding-world-tracking).
## [See Also](https://developer.apple.com/documentation/arkit/aranchor/transform#see-also)
### [Tracking Anchors](https://developer.apple.com/documentation/arkit/aranchor/transform#Tracking-Anchors)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Farkit%2Faranchor%2Ftransform).
