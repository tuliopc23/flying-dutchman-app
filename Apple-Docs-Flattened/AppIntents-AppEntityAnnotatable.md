Source: https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable

[ Skip Navigation ](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable)
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 2 symbols inside -1388569960 
System protocols
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
rP
2 of 2 symbols inside -1388569960 containing 2 symbols[AppEntityAnnotatable](https://developer.apple.com/documentation/appintents/appentityannotatable)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 2 symbols inside -115063415 
Instance Properties
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 2 symbols inside -115063415 [var appEntityIdentifier: EntityIdentifier?](https://developer.apple.com/documentation/appintents/appentityannotatable/appentityidentifier)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
Collection
...
iOS 18.2+iPadOS 18.2+Mac CatalystmacOS 15.2+tvOS 18.2+visionOS 2.2+watchOS 11.2+
```
protocol AppEntityAnnotatable
```

## [Overview](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable#overview)
...
## [Topics](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable#topics)
### [Instance Properties](https://developer.apple.com/documentation/AppIntents/AppEntityAnnotatable#Instance-Properties)
[`var appEntityIdentifier: EntityIdentifier?`](https://developer.apple.com/documentation/appintents/appentityannotatable/appentityidentifier)
The identifier of an app entity you set on framework types to make app content available to system experiences.
**Required**
Current page is AppEntityAnnotatable 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FAppIntents%2FAppEntityAnnotatable).
