Source: https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice

[ Skip Navigation ](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 13 symbols inside 547121733 
Checking permission to generate URLs
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
2 of 13 symbols inside 547121733 [class var authorizationStatus: AVAuthorizationStatus](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/authorizationstatus)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 13 symbols inside 547121733 
Requesting permission to generate URLs
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
4 of 13 symbols inside 547121733 [class func requestAccess(completionHandler: (Bool) -> Void)](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/requestaccess\(completionhandler:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
5 of 13 symbols inside 547121733 
Generating URLs for image assets
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
6 of 13 symbols inside 547121733 [func nextAvailableURLs(withPathExtensions: [String]) throws -> [URL]](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/nextavailableurls\(withpathextensions:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
7 of 13 symbols inside 547121733 
Inspecting a storage device
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
8 of 13 symbols inside 547121733 [var isConnected: Bool](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/isconnected)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
9 of 13 symbols inside 547121733 [var displayName: String?](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/displayname)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
10 of 13 symbols inside 547121733 [var uuid: UUID?](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/uuid)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
11 of 13 symbols inside 547121733 [var freeSize: Int](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/freesize)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
12 of 13 symbols inside 547121733 [var totalSize: Int](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/totalsize)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
13 of 13 symbols inside 547121733 [var isNotRecommendedForCaptureUse: Bool](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/isnotrecommendedforcaptureuse)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
Navigator is ready 
  * [ AVFoundation ](https://developer.apple.com/documentation/avfoundation)
  * [ AVExternalStorageDevice ](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice)
...
## [Overview](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#overview)
...
## [Topics](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#topics)
### [Checking permission to generate URLs](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#Checking-permission-to-generate-URLs)
[`class var authorizationStatus: AVAuthorizationStatus`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/authorizationstatus)
Your app’s authorization status for the external storage device.
### [Requesting permission to generate URLs](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#Requesting-permission-to-generate-URLs)
[`class func requestAccess(completionHandler: (Bool) -> Void)`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/requestaccess\(completionhandler:\))
...
### [Generating URLs for image assets](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#Generating-URLs-for-image-assets)
[`func nextAvailableURLs(withPathExtensions: [String]) throws -> [URL]`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/nextavailableurls\(withpathextensions:\))
...
### [Inspecting a storage device](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#Inspecting-a-storage-device)
[`var isConnected: Bool`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/isconnected)
A Boolean value that indicates whether the system has a connection to the external storage device.
[`var displayName: String?`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/displayname)
The name of an external storage device that’s appropriate for a user interface.
[`var uuid: UUID?`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/uuid)
The external storage device’s unique identifier.
[`var freeSize: Int`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/freesize)
The amount of free storage space, in bytes, that’s available on the external storage device.
[`var totalSize: Int`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/totalsize)
The total amount of storage space, in bytes, that’s available on the external storage device.
[`var isNotRecommendedForCaptureUse: Bool`](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice/isnotrecommendedforcaptureuse)
A Boolean value that indicates whether the external storage device is suitable for camera capture.
## [Relationships](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#relationships)
### [Inherits From](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#see-also)
### [Capture devices](https://developer.apple.com/documentation/avfoundation/avexternalstoragedevice#Capture-devices)
...
[Adopting smart framing in your camera app](https://developer.apple.com/documentation/avfoundation/adopting-smart-framing-in-your-camera-app)
...
Current page is AVExternalStorageDevice 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Favfoundation%2Favexternalstoragedevice).
