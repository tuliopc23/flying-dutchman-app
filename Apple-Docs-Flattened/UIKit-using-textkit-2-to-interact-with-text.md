Source: https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text

[ Skip Navigation ](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text)
...
[ Download ](https://docs-assets.developer.apple.com/published/806998142c63/UsingTextKit2ToInteractWithText.zip)
iOS 16.0+iPadOS 16.0+macOS 13.0+Xcode 14.3+
## [Overview](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text#Overview)
Note
This sample code project is associated with WWDC21 session [10061: Meet TextKit 2](https://developer.apple.com/wwdc21/10061/).
## [See Also](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text#see-also)
### [Layout](https://developer.apple.com/documentation/uikit/using-textkit-2-to-interact-with-text#Layout)
...
Current page is Using TextKit 2 to interact with text 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fuikit%2Fusing-textkit-2-to-interact-with-text).
