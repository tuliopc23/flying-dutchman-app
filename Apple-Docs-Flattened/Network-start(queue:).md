Source: https://developer.apple.com/documentation/network/nwconnection/start(queue:)

[ Skip Navigation ](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\)#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\)#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\))
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\))
  * SwiftLanguage: Swift


[](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\))
...
Navigator is ready 
  ...
  * [ start(queue:) ](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\))
  *     * [ NWConnection ](https://developer.apple.com/documentation/network/nwconnection)
    * start(queue:) 
...
```
final func start(queue: [DispatchQueue](https://developer.apple.com/documentation/Dispatch/DispatchQueue))
```

## [See Also](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\)#see-also)
### [Creating Connections](https://developer.apple.com/documentation/network/nwconnection/start\(queue:\)#Creating-Connections)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fnetwork%2Fnwconnection%2Fstart\(queue%3A\)).
