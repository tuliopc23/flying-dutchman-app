...
[ Skip Navigation ](https://developer.apple.com/documentation/swiftdata/defaulthistorydelete#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/swiftdata/defaulthistorydelete#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/swiftdata/defaulthistorydelete)
...
```
struct DefaultHistoryDelete<Model> where Model : [PersistentModel](https://developer.apple.com/documentation/swiftdata/persistentmodel)
```
