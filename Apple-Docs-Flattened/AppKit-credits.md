Source: https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits

[ Skip Navigation ](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits)


[](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits)
...
Navigator is ready 
  ...
  * [ credits ](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits)
  *     * [ NSApplication ](https://developer.apple.com/documentation/appkit/nsapplication)
    * [ NSApplication.AboutPanelOptionKey ](https://developer.apple.com/documentation/appkit/nsapplication/aboutpaneloptionkey)
    * credits 
...
macOS 10.13+
```
static let credits: [NSApplication](https://developer.apple.com/documentation/appkit/nsapplication).[AboutPanelOptionKey](https://developer.apple.com/documentation/appkit/nsapplication/aboutpaneloptionkey)
```

## [Discussion](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits#Discussion)
...
## [See Also](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits#see-also)
### [Option Keys](https://developer.apple.com/documentation/AppKit/NSApplication/AboutPanelOptionKey/credits#Option-Keys)
[`static let applicationIcon: NSApplication.AboutPanelOptionKey`](https://developer.apple.com/documentation/appkit/nsapplication/aboutpaneloptionkey/applicationicon)
The icon to display for the app in the About panel.
[`static let applicationName: NSApplication.AboutPanelOptionKey`](https://developer.apple.com/documentation/appkit/nsapplication/aboutpaneloptionkey/applicationname)
The name of the application to display in the About panel.
[`static let applicationVersion: NSApplication.AboutPanelOptionKey`](https://developer.apple.com/documentation/appkit/nsapplication/aboutpaneloptionkey/applicationversion)
The version information to display in the About panel.
[`static let version: NSApplication.AboutPanelOptionKey`](https://developer.apple.com/documentation/appkit/nsapplication/aboutpaneloptionkey/version)
