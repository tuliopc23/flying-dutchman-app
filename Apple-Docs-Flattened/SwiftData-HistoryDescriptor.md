Source: https://developer.apple.com/documentation/swiftdata/historydescriptor

[ Skip Navigation ](https://developer.apple.com/documentation/swiftdata/historydescriptor#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/swiftdata/historydescriptor#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/swiftdata/historydescriptor)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/swiftdata/historydescriptor)
  * SwiftLanguage: Swift
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 7 symbols inside 979126878 
Creating a descriptor
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 7 symbols inside 979126878 [init(predicate: Predicate<TransactionType>?)](https://developer.apple.com/documentation/swiftdata/historydescriptor/init\(predicate:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 7 symbols inside 979126878 [init(predicate: Predicate<TransactionType>?, sortBy: [SortDescriptor<TransactionType>])](https://developer.apple.com/documentation/swiftdata/historydescriptor/init\(predicate:sortby:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
4 of 7 symbols inside 979126878 
Getting the descriptor configuration
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
5 of 7 symbols inside 979126878 [var fetchLimit: UInt64](https://developer.apple.com/documentation/swiftdata/historydescriptor/fetchlimit)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
6 of 7 symbols inside 979126878 [var predicate: Predicate<TransactionType>?](https://developer.apple.com/documentation/swiftdata/historydescriptor/predicate)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
P
7 of 7 symbols inside 979126878 [var sortBy: [SortDescriptor<TransactionType>]](https://developer.apple.com/documentation/swiftdata/historydescriptor/sortby)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
```
struct HistoryDescriptor<TransactionType> where TransactionType : [HistoryTransaction](https://developer.apple.com/documentation/swiftdata/historytransaction)
```

## [Topics](https://developer.apple.com/documentation/swiftdata/historydescriptor#topics)
### [Creating a descriptor](https://developer.apple.com/documentation/swiftdata/historydescriptor#Creating-a-descriptor)
[`init(predicate: Predicate<TransactionType>?)`](https://developer.apple.com/documentation/swiftdata/historydescriptor/init\(predicate:\))
Initializes a new history descriptor with the provided predicate.
[`init(predicate: Predicate<TransactionType>?, sortBy: [SortDescriptor<TransactionType>])`](https://developer.apple.com/documentation/swiftdata/historydescriptor/init\(predicate:sortby:\))
Initializes a new history descriptor with the provided predicate and sort descriptor.
### [Getting the descriptor configuration](https://developer.apple.com/documentation/swiftdata/historydescriptor#Getting-the-descriptor-configuration)
[`var fetchLimit: UInt64`](https://developer.apple.com/documentation/swiftdata/historydescriptor/fetchlimit)
The maximum number of transactions to retrieve from the model store’s history.
[`var predicate: Predicate<TransactionType>?`](https://developer.apple.com/documentation/swiftdata/historydescriptor/predicate)
The predicate used to initialize the history descriptor.
[`var sortBy: [SortDescriptor<TransactionType>]`](https://developer.apple.com/documentation/swiftdata/historydescriptor/sortby)
The sort descriptor to use to sort the returned history data.
## [See Also](https://developer.apple.com/documentation/swiftdata/historydescriptor#see-also)
### [Model life cycle](https://developer.apple.com/documentation/swiftdata/historydescriptor#Model-life-cycle)
...
Current page is HistoryDescriptor 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fswiftdata%2Fhistorydescriptor).
