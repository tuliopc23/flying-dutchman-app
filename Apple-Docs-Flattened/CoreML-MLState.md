...
[ Skip Navigation ](https://developer.apple.com/documentation/CoreML/MLState#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/CoreML/MLState#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/CoreML/MLState)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/CoreML/MLState)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/CoreML/MLState)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 3 symbols inside 1547156214 
Getting a state buffer
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
2 of 3 symbols inside 1547156214 [func withMultiArray<R>(for: String, (MLMultiArray) throws -> R) rethrows -> R](https://developer.apple.com/documentation/coreml/mlstate/withmultiarray\(for:_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
M
3 of 3 symbols inside 1547156214 [func withMultiArray<R>((MLMultiArray) -> R) throws -> R](https://developer.apple.com/documentation/coreml/mlstate/withmultiarray\(_:\))Deprecated
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
## [Overview](https://developer.apple.com/documentation/CoreML/MLState#overview)
...
## [Topics](https://developer.apple.com/documentation/CoreML/MLState#topics)
### [Getting a state buffer](https://developer.apple.com/documentation/CoreML/MLState#Getting-a-state-buffer)
[`func withMultiArray<R>(for: String, (MLMultiArray) throws -> R) rethrows -> R`](https://developer.apple.com/documentation/coreml/mlstate/withmultiarray\(for:_:\))
[`func withMultiArray<R>((MLMultiArray) -> R) throws -> R`](https://developer.apple.com/documentation/coreml/mlstate/withmultiarray\(_:\))Deprecated
## [Relationships](https://developer.apple.com/documentation/CoreML/MLState#relationships)
### [Inherits From](https://developer.apple.com/documentation/CoreML/MLState#inherits-from)
  * [`NSObject`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class)


### [Conforms To](https://developer.apple.com/documentation/CoreML/MLState#conforms-to)
...
## [See Also](https://developer.apple.com/documentation/CoreML/MLState#see-also)
### [Model state](https://developer.apple.com/documentation/CoreML/MLState#Model-state)
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2FCoreML%2FMLState).
