Source: https://developer.apple.com/documentation/uikit/uikit-functions

[ Skip Navigation ](https://developer.apple.com/documentation/uikit/uikit-functions#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/uikit/uikit-functions#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/uikit/uikit-functions)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/uikit/uikit-functions)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/uikit/uikit-functions)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 7 symbols inside 734691171 
Functions
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
2 of 7 symbols inside 734691171 [func UIDeviceOrientationIsLandscape(UIDeviceOrientation) -> Bool](https://developer.apple.com/documentation/uikit/uideviceorientationislandscape\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
3 of 7 symbols inside 734691171 [func UIDeviceOrientationIsPortrait(UIDeviceOrientation) -> Bool](https://developer.apple.com/documentation/uikit/uideviceorientationisportrait\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
4 of 7 symbols inside 734691171 [func UIDeviceOrientationIsValidInterfaceOrientation(UIDeviceOrientation) -> Bool](https://developer.apple.com/documentation/uikit/uideviceorientationisvalidinterfaceorientation\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
5 of 7 symbols inside 734691171 [func UIInterfaceOrientationIsLandscape(UIInterfaceOrientation) -> Bool](https://developer.apple.com/documentation/uikit/uiinterfaceorientationislandscape\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
6 of 7 symbols inside 734691171 [func UIInterfaceOrientationIsPortrait(UIInterfaceOrientation) -> Bool](https://developer.apple.com/documentation/uikit/uiinterfaceorientationisportrait\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
7 of 7 symbols inside 734691171 [func UIWritingToolsCoordinatorTextAnimationDebugDescription(UIWritingToolsCoordinator.TextAnimation) -> String](https://developer.apple.com/documentation/uikit/uiwritingtoolscoordinatortextanimationdebugdescription\(_:\))
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
...
## [Topics](https://developer.apple.com/documentation/uikit/uikit-functions#topics)
### [Functions](https://developer.apple.com/documentation/uikit/uikit-functions#Functions)
[`func UIDeviceOrientationIsLandscape(UIDeviceOrientation) -> Bool`](https://developer.apple.com/documentation/uikit/uideviceorientationislandscape\(_:\))
[`func UIDeviceOrientationIsPortrait(UIDeviceOrientation) -> Bool`](https://developer.apple.com/documentation/uikit/uideviceorientationisportrait\(_:\))
[`func UIDeviceOrientationIsValidInterfaceOrientation(UIDeviceOrientation) -> Bool`](https://developer.apple.com/documentation/uikit/uideviceorientationisvalidinterfaceorientation\(_:\))
[`func UIInterfaceOrientationIsLandscape(UIInterfaceOrientation) -> Bool`](https://developer.apple.com/documentation/uikit/uiinterfaceorientationislandscape\(_:\))
[`func UIInterfaceOrientationIsPortrait(UIInterfaceOrientation) -> Bool`](https://developer.apple.com/documentation/uikit/uiinterfaceorientationisportrait\(_:\))
[`func UIWritingToolsCoordinatorTextAnimationDebugDescription(UIWritingToolsCoordinator.TextAnimation) -> String`](https://developer.apple.com/documentation/uikit/uiwritingtoolscoordinatortextanimationdebugdescription\(_:\))
## [See Also](https://developer.apple.com/documentation/uikit/uikit-functions#see-also)
### [Reference](https://developer.apple.com/documentation/uikit/uikit-functions#Reference)
...
Current page is UIKit Functions 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fuikit%2Fuikit-functions).
