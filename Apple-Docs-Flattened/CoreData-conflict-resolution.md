Source: https://developer.apple.com/documentation/coredata/conflict-resolution

[ Skip Navigation ](https://developer.apple.com/documentation/coredata/conflict-resolution#app-main)
  * [Global Nav Open Menu](https://developer.apple.com/documentation/coredata/conflict-resolution#ac-gn-menustate)[Global Nav Close Menu](https://developer.apple.com/documentation/coredata/conflict-resolution)
...
5 Quick Links
[ Documentation ](https://developer.apple.com/documentation)
[ Open Menu ](https://developer.apple.com/documentation/coredata/conflict-resolution)
  * SwiftLanguage:  Swift  Objective-C 
Language: 
    * Swift 
    * [ Objective-C ](https://developer.apple.com/documentation/coredata/conflict-resolution)
...
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
1 of 5 symbols inside -1017895141 
Conflict Management
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
2 of 5 symbols inside -1017895141 containing 9 symbols[NSConstraintConflict](https://developer.apple.com/documentation/coredata/nsconstraintconflict)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
3 of 5 symbols inside -1017895141 containing 9 symbols[NSMergeConflict](https://developer.apple.com/documentation/coredata/nsmergeconflict)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
4 of 5 symbols inside -1017895141 containing 14 symbols[NSMergePolicy](https://developer.apple.com/documentation/coredata/nsmergepolicy)
To navigate the symbols, press Up Arrow, Down Arrow, Left Arrow or Right Arrow 
C
...
## [Topics](https://developer.apple.com/documentation/coredata/conflict-resolution#topics)
### [Conflict Management](https://developer.apple.com/documentation/coredata/conflict-resolution#Conflict-Management)
[`class NSConstraintConflict`](https://developer.apple.com/documentation/coredata/nsconstraintconflict)
An encapsulation of conflicts that occur during an attempt to save a managed object.
[`class NSMergeConflict`](https://developer.apple.com/documentation/coredata/nsmergeconflict)
An encapsulation of conflicts that occur during an attempt to save changes in a managed object context.
[`class NSMergePolicy`](https://developer.apple.com/documentation/coredata/nsmergepolicy)
A policy object that you use to resolve conflicts between the persistent store and in-memory versions of managed objects.
[`class NSQueryGenerationToken`](https://developer.apple.com/documentation/coredata/nsquerygenerationtoken)
A token that indicates which generation of the persistent store is being accessed.
## [See Also](https://developer.apple.com/documentation/coredata/conflict-resolution#see-also)
### [Background tasks](https://developer.apple.com/documentation/coredata/conflict-resolution#Background-tasks)
...
Current page is Conflict resolution 
...
To submit feedback on documentation, visit [Feedback Assistant](applefeedback://new?form_identifier=developertools.fba&answers%5B%3Aarea%5D=seedADC%3Adevpubs&answers%5B%3Adoc_type_req%5D=Technology%20Documentation&answers%5B%3Adocumentation_link_req%5D=https%3A%2F%2Fdeveloper.apple.com%2Fdocumentation%2Fcoredata%2Fconflict-resolution).
